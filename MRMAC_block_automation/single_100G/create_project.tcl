...
#
# Generated by Vivado on Sat Mar 21 15:10:01 GMT 2026
...
proc cr_bd_MRMAC_block_automation { parentCell } {
  ...
  set_property -dict [list \
    ...
    CONFIG.MRMAC_DATA_PATH_INTERFACE_PORT0_C0 {Low Latency 256b Non-Segmented} \
  ...
  set_property -dict [list \
    ...
    CONFIG.CHANNEL_ORDERING {/gt_quad_base/TX0_GT_IP_Interface MRMAC_block_automation_mrmac_0_0_0./mrmac_0/gt_tx_serdes_interface_0.0 /gt_quad_base/TX1_GT_IP_Interface MRMAC_block_automation_mrmac_0_0_0./mrmac_0/gt_tx_serdes_interface_1.1\
/gt_quad_base/TX2_GT_IP_Interface MRMAC_block_automation_mrmac_0_0_0./mrmac_0/gt_tx_serdes_interface_2.2 /gt_quad_base/TX3_GT_IP_Interface MRMAC_block_automation_mrmac_0_0_0./mrmac_0/gt_tx_serdes_interface_3.3\
/gt_quad_base/RX0_GT_IP_Interface MRMAC_block_automation_mrmac_0_0_0./mrmac_0/gt_rx_serdes_interface_0.0 /gt_quad_base/RX1_GT_IP_Interface MRMAC_block_automation_mrmac_0_0_0./mrmac_0/gt_rx_serdes_interface_1.1\
/gt_quad_base/RX2_GT_IP_Interface MRMAC_block_automation_mrmac_0_0_0./mrmac_0/gt_rx_serdes_interface_2.2 /gt_quad_base/RX3_GT_IP_Interface MRMAC_block_automation_mrmac_0_0_0./mrmac_0/gt_rx_serdes_interface_3.3}\
\
    CONFIG.GT_TYPE {GTY} \
...
DISABLE RX_BUFFER_RESET_ON_RATE_CHANGE ENABLE RESET_SEQUENCE_INTERVAL 0 RX_COMMA_PRESET NONE RX_COMMA_VALID_ONLY 0 GT_TYPE GTY} \
    ...
    CONFIG.QUAD_USAGE {TX_QUAD_CH {TXQuad_0_/gt_quad_base {/gt_quad_base MRMAC_block_automation_mrmac_0_0_0.IP_CH0,MRMAC_block_automation_mrmac_0_0_0.IP_CH1,MRMAC_block_automation_mrmac_0_0_0.IP_CH2,MRMAC_block_automation_mrmac_0_0_0.IP_CH3\
MSTRCLK 1,0,0,0 IS_CURRENT_QUAD 1}} RX_QUAD_CH {RXQuad_0_/gt_quad_base {/gt_quad_base MRMAC_block_automation_mrmac_0_0_0.IP_CH0,MRMAC_block_automation_mrmac_0_0_0.IP_CH1,MRMAC_block_automation_mrmac_0_0_0.IP_CH2,MRMAC_block_automation_mrmac_0_0_0.IP_CH3\
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xcvm1802-vsva2197-2MP-e-S -flow {Vivado Synthesis 2025} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xcvm1802-vsva2197-2MP-e-S -flow {Vivado Advanced Implementation 2025} -strategy "Vivado Advanced Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
