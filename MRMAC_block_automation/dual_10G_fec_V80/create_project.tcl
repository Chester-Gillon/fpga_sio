...
#
# Generated by Vivado on Sat Sep 19 15:39:47 BST 2026
...
# Create project
create_project ${_xil_proj_name_} ./${_xil_proj_name_} -part xcv80-lsva4737-2MHP-e-S
...
RPLL TX_REFCLK_FREQUENCY 322.265625 TX_ACTUAL_REFCLK_FREQUENCY 322.265625000000 TX_FRACN_ENABLED false TX_FRACN_OVRD false TX_FRACN_NUMERATOR 0 TX_REFCLK_SOURCE R0 TX_DATA_ENCODING RAW TX_USER_DATA_WIDTH\
32 TX_INT_DATA_WIDTH 32 TX_BUFFER_MODE 1 TX_BUFFER_BYPASS_MODE Fast_Sync TX_PIPM_ENABLE false TX_OUTCLK_SOURCE TXPROGDIVCLK TXPROGDIV_FREQ_ENABLE true TXPROGDIV_FREQ_SOURCE RPLL TXPROGDIV_FREQ_VAL 644.531\
...
NRZ RX_HD_EN 0 RX_GRAY_BYP true RX_GRAY_LITTLEENDIAN true RX_PRECODE_BYP true RX_PRECODE_LITTLEENDIAN false INTERNAL_PRESET None XPU_MODE 0 RX_LINE_RATE 10.3125 RX_PLL_TYPE RPLL RX_REFCLK_FREQUENCY 322.265625\
RX_ACTUAL_REFCLK_FREQUENCY 322.265625000000 RX_FRACN_ENABLED false RX_FRACN_OVRD false RX_FRACN_NUMERATOR 0 RX_REFCLK_SOURCE R0 RX_DATA_DECODING RAW RX_USER_DATA_WIDTH 32 RX_INT_DATA_WIDTH 32 RX_BUFFER_MODE\
...
1}} RX_QUAD_CH {RXQuad_0_/gt_quad_base {/gt_quad_base MRMAC_block_automation_mrmac_0_0_0.IP_CH0,MRMAC_block_automation_mrmac_0_0_1.IP_CH1,undef,undef MSTRCLK 1,1,0,0 IS_CURRENT_QUAD 1}}} \
    ...
    CONFIG.REFCLK_STRING {HSCLK0_RPLLGTREFCLK0 refclk_PROT0_R0_PROT1_R0_322.265625_MHz_unique1} \
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xcv80-lsva4737-2MHP-e-S -flow {Vivado Synthesis 2026} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xcv80-lsva4737-2MHP-e-S -flow {Vivado Advanced Implementation 2026} -strategy "Vivado Advanced Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
