#! /bin/bash
# Wrapper script to call boot_hw_device.tcl using the Vivado lab tools under Linux
...
${VIVADO_LAB_EXE} -notrace -nolog -nojournal -mode batch -source ${SCRIPT_PATH}/boot_hw_device.tcl -tclargs ${bitstream_filename}
