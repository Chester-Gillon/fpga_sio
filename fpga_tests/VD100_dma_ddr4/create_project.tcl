...
#
# create_project.tcl: Tcl script for re-creating project 'VD100_dma_ddr4'
#
# Generated by Vivado on Mon Dec 22 09:53:55 GMT 2025
...
set _xil_proj_name_ "VD100_dma_ddr4"
...
set orig_proj_dir "[file normalize "$origin_dir/VD100_dma_ddr4"]"
...
set_msg_config  -id {[Synth 8-7129]}  -suppress  -ruleid {4}  -source 2
set_msg_config  -id {[Synth 8-3848]}  -suppress  -ruleid {5}  -source 2
...
set_property -name "top" -value "VD100_dma_ddr4_wrapper" -objects $obj
...
# Proc to create BD VD100_dma_ddr4
proc cr_bd_VD100_dma_ddr4 { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name VD100_dma_ddr4
...
32 RX_REFCLK_FREQUENCY 100} \
    CONFIG.INTF0_PARENTID {VD100_dma_ddr4_pcie_phy_0} \
...
refclk_PROT0_R0_100_MHz_unique1} \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net PL_CLK0_1 [get_bd_intf_ports PL_CLK0] [get_bd_intf_pins axi_noc_0/sys_clk0]
  ...
  connect_bd_intf_net -intf_net xdma_0_M_AXI [get_bd_intf_pins xdma_0/M_AXI] [get_bd_intf_pins axi_noc_0/S00_AXI]
  ...
  assign_bd_address -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces xdma_0/M_AXI] [get_bd_addr_segs axi_noc_0/S00_AXI/C0_DDR_LOW1] -force
...
# End of cr_bd_VD100_dma_ddr4()

cr_bd_VD100_dma_ddr4 ""
set_property REGISTERED_WITH_MANAGER "1" [get_files VD100_dma_ddr4.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files VD100_dma_ddr4.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list VD100_dma_ddr4.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/VD100_dma_ddr4/VD100_dma_ddr4.gen/sources_1/bd/VD100_dma_ddr4/hdl/VD100_dma_ddr4_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list VD100_dma_ddr4.bd]] -top]
