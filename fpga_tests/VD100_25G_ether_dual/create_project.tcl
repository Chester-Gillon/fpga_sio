...
#
# create_project.tcl: Tcl script for re-creating project 'VD100_25G_ether_dual'
#
# Generated by Vivado on Sat Mar 28 16:09:02 GMT 2026
...
set _xil_proj_name_ "VD100_25G_ether_dual"
...
set orig_proj_dir "[file normalize "$origin_dir/VD100_25G_ether_dual"]"
...
set_property -name "top" -value "VD100_25G_ether_dual_wrapper" -objects $obj
...
# Proc to create BD mrmac_25G_dual
proc cr_bd_mrmac_25G_dual { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name mrmac_25G_dual
  ...
  set mrmac_axis_rx_aclk_0_1 [ create_bd_port -dir O -from 0 -to 0 -type clk mrmac_axis_rx_aclk_0_1 ]
  ...
  set_property -dict [list \
    ...
    CONFIG.CHANNEL_ORDERING {/gt_quad_base/TX0_GT_IP_Interface mrmac_25G_dual_mrmac_0_0_0./mrmac_0/gt_tx_serdes_interface_0.0 /gt_quad_base/TX1_GT_IP_Interface mrmac_25G_dual_mrmac_0_0_1./mrmac_0/gt_tx_serdes_interface_1.1\
/gt_quad_base/RX0_GT_IP_Interface mrmac_25G_dual_mrmac_0_0_0./mrmac_0/gt_rx_serdes_interface_0.0 /gt_quad_base/RX1_GT_IP_Interface mrmac_25G_dual_mrmac_0_0_1./mrmac_0/gt_rx_serdes_interface_1.1} \
    CONFIG.GT_TYPE {GTYP} \
...
DISABLE RX_BUFFER_RESET_ON_RATE_CHANGE ENABLE RESET_SEQUENCE_INTERVAL 0 RX_COMMA_PRESET NONE RX_COMMA_VALID_ONLY 0 GT_TYPE GTYP} \
    ...
    CONFIG.QUAD_USAGE {TX_QUAD_CH {TXQuad_0_/gt_quad_base {/gt_quad_base mrmac_25G_dual_mrmac_0_0_0.IP_CH0,mrmac_25G_dual_mrmac_0_0_1.IP_CH1,undef,undef MSTRCLK 1,1,0,0 IS_CURRENT_QUAD 1}} RX_QUAD_CH {RXQuad_0_/gt_quad_base\
{/gt_quad_base mrmac_25G_dual_mrmac_0_0_0.IP_CH0,mrmac_25G_dual_mrmac_0_0_1.IP_CH1,undef,undef MSTRCLK 1,1,0,0 IS_CURRENT_QUAD 1}}} \
  ...
  [get_bd_ports mrmac_axis_rx_aclk_0_1]
...
# End of cr_bd_mrmac_25G_dual()

cr_bd_mrmac_25G_dual ""
set_property REGISTERED_WITH_MANAGER "1" [get_files mrmac_25G_dual.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files mrmac_25G_dual.bd ] 
...
proc cr_bd_mrmac_h2c_stream { parentCell } {
  ...
  set tx_axis_tdata_lower [ create_bd_port -dir O -from 63 -to 0 tx_axis_tdata_lower ]
  set tx_axis_tdata_upper [ create_bd_port -dir O -from 63 -to 0 tx_axis_tdata_upper ]
  set tx_axis_tkeep_user_lower [ create_bd_port -dir O -from 10 -to 0 tx_axis_tkeep_user_lower ]
  set tx_axis_tkeep_user_upper [ create_bd_port -dir O -from 10 -to 0 tx_axis_tkeep_user_upper ]
  ...
  connect_bd_net -net ilconcat_0_dout  [get_bd_pins ilconcat_0/dout] \
  [get_bd_ports tx_axis_tkeep_user_lower]
  connect_bd_net -net ilconcat_1_dout  [get_bd_pins ilconcat_1/dout] \
  [get_bd_ports tx_axis_tkeep_user_upper]
  connect_bd_net -net ilslice_0_Dout  [get_bd_pins ilslice_0/Dout] \
  [get_bd_ports tx_axis_tdata_lower]
  connect_bd_net -net ilslice_1_Dout  [get_bd_pins ilslice_1/Dout] \
  [get_bd_ports tx_axis_tdata_upper]
...
proc cr_bd_mrmac_c2h_stream { parentCell } {
  ...
  # Create ports
  set rx_axis_tdata_lower [ create_bd_port -dir I -from 63 -to 0 rx_axis_tdata_lower ]
  set rx_axis_tdata_upper [ create_bd_port -dir I -from 63 -to 0 rx_axis_tdata_upper ]
  set rx_axis_tkeep_user_lower [ create_bd_port -dir I -from 10 -to 0 rx_axis_tkeep_user_lower ]
  set rx_axis_tkeep_user_upper [ create_bd_port -dir I -from 10 -to 0 rx_axis_tkeep_user_upper ]
  set rx_axis_tlast [ create_bd_port -dir I rx_axis_tlast ]
  set rx_axis_tvalid [ create_bd_port -dir I rx_axis_tvalid ]
  ...
  [get_bd_pins axis_dwidth_converter_0/aresetn] \
  [get_bd_pins axis_data_fifo_1/s_axis_aresetn]
  connect_bd_net -net rx_axis_tdata_lower_1  [get_bd_ports rx_axis_tdata_lower] \
  [get_bd_pins ilconcat_0/In0]
  connect_bd_net -net rx_axis_tdata_upper_1  [get_bd_ports rx_axis_tdata_upper] \
  [get_bd_pins ilconcat_0/In1]
  connect_bd_net -net rx_axis_tkeep_user_lower_1  [get_bd_ports rx_axis_tkeep_user_lower] \
  [get_bd_pins ilslice_0/Din]
  connect_bd_net -net rx_axis_tkeep_user_upper_1  [get_bd_ports rx_axis_tkeep_user_upper] \
  [get_bd_pins ilslice_1/Din]
...
# Proc to create BD VD100_25G_ether_dual
proc cr_bd_VD100_25G_ether_dual { parentCell } {
# The design that will be created by this Tcl proc contains the following 
# block design container source references:
# mrmac_25G_dual, mrmac_h2c_stream, mrmac_c2h_stream



  # CHANGE DESIGN NAME HERE
  set design_name VD100_25G_ether_dual
  ...
  ##################################################################
  set bCheckSources 1
  set list_bdc_active "mrmac_25G_dual, mrmac_h2c_stream, mrmac_c2h_stream"
...
32 RX_REFCLK_FREQUENCY 100} \
    CONFIG.INTF0_PARENTID {VD100_25G_ether_dual_pcie_phy_0} \
...
refclk_PROT0_R0_100_MHz_unique1} \
  ...
  connect_bd_intf_net -intf_net Conn9 [get_bd_intf_pins pcie/pcie_cfg_control] [get_bd_intf_pins pcie_cfg_control]
  connect_bd_intf_net -intf_net Conn10 [get_bd_intf_pins pcie/pcie_cfg_fc] [get_bd_intf_pins pcie_cfg_fc]
  connect_bd_intf_net -intf_net Conn11 [get_bd_intf_pins pcie/pcie_cfg_mgmt] [get_bd_intf_pins pcie_cfg_mgmt]
  connect_bd_intf_net -intf_net Conn12 [get_bd_intf_pins pcie/pcie_cfg_status] [get_bd_intf_pins pcie_cfg_status]
  connect_bd_intf_net -intf_net Conn13 [get_bd_intf_pins pcie/pcie_transmit_fc] [get_bd_intf_pins pcie_transmit_fc]
  connect_bd_intf_net -intf_net Conn14 [get_bd_intf_pins pcie/s_axis_cc] [get_bd_intf_pins s_axis_cc]
  connect_bd_intf_net -intf_net Conn15 [get_bd_intf_pins pcie/s_axis_rq] [get_bd_intf_pins s_axis_rq]
  ...
  # Create instance: mrmac_25G_dual_0, and set properties
  set mrmac_25G_dual_0 [ create_bd_cell -type container -reference mrmac_25G_dual mrmac_25G_dual_0 ]
  set_property -dict [list \
    CONFIG.ACTIVE_SIM_BD {mrmac_25G_dual.bd} \
    CONFIG.ACTIVE_SYNTH_BD {mrmac_25G_dual.bd} \
    CONFIG.ENABLE_DFX {0} \
    CONFIG.LIST_SIM_BD {mrmac_25G_dual.bd} \
    CONFIG.LIST_SYNTH_BD {mrmac_25G_dual.bd} \
    CONFIG.LOCK_PROPAGATE {0} \
  ] $mrmac_25G_dual_0


  set_property SELECTED_SIM_MODEL rtl  $mrmac_25G_dual_0
  ...
  # Create instance: mrmac_c2h_stream_1, and set properties
  set mrmac_c2h_stream_1 [ create_bd_cell -type container -reference mrmac_c2h_stream mrmac_c2h_stream_1 ]
  set_property -dict [list \
    CONFIG.ACTIVE_SIM_BD {mrmac_c2h_stream.bd} \
    CONFIG.ACTIVE_SYNTH_BD {mrmac_c2h_stream.bd} \
    CONFIG.ENABLE_DFX {0} \
  ...
  set_property SELECTED_SIM_MODEL rtl  $mrmac_c2h_stream_1

  # Create interface connections
  connect_bd_intf_net -intf_net H2C_AXIS_1 [get_bd_intf_pins mrmac_h2c_stream_1/H2C_AXIS] [get_bd_intf_pins xdma_0/M_AXIS_H2C_1]
  connect_bd_intf_net -intf_net SFP_REF_1 [get_bd_intf_pins mrmac_25G_dual_0/SFP_REF] [get_bd_intf_ports SFP_REF]
  ...
  connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins axi_smc/M02_AXI] [get_bd_intf_pins mrmac_25G_dual_0/s_axi]
  connect_bd_intf_net -intf_net mrmac_25G_dual_0_SFP_serial [get_bd_intf_pins mrmac_25G_dual_0/SFP_serial] [get_bd_intf_ports SFP_serial]
  ...
  connect_bd_intf_net -intf_net mrmac_c2h_stream_1_C2H_AXIS [get_bd_intf_pins mrmac_c2h_stream_1/C2H_AXIS] [get_bd_intf_pins xdma_0/S_AXIS_C2H_1]
  ...
  # Create port connections
  connect_bd_net -net Net  [get_bd_pins axi_gpio_0/gpio2_io_o] \
  [get_bd_pins ilslice_0/Din] \
  ...
  connect_bd_net -net mrmac_25G_dual_0_rx_axis_tkeep_user1  [get_bd_pins mrmac_25G_dual_0/rx_axis_tkeep_user1] \
  [get_bd_pins mrmac_c2h_stream_0/rx_axis_tkeep_user_upper]
  connect_bd_net -net mrmac_25G_dual_0_rx_axis_tlast_0  [get_bd_pins mrmac_25G_dual_0/rx_axis_tlast_0] \
  [get_bd_pins mrmac_c2h_stream_0/rx_axis_tlast]
  connect_bd_net -net mrmac_25G_dual_0_rx_axis_tlast_1  [get_bd_pins mrmac_25G_dual_0/rx_axis_tlast_1] \
  [get_bd_pins mrmac_c2h_stream_1/rx_axis_tlast]
  connect_bd_net -net mrmac_25G_dual_0_rx_axis_tvalid_0  [get_bd_pins mrmac_25G_dual_0/rx_axis_tvalid_0] \
  [get_bd_pins mrmac_c2h_stream_0/rx_axis_tvalid]
  connect_bd_net -net mrmac_25G_dual_0_rx_axis_tvalid_1  [get_bd_pins mrmac_25G_dual_0/rx_axis_tvalid_1] \
  [get_bd_pins mrmac_c2h_stream_1/rx_axis_tvalid]
  connect_bd_net -net mrmac_axis_rx_aclk_1  [get_bd_pins mrmac_25G_dual_0/mrmac_axis_rx_aclk_0_1] \
  [get_bd_pins mrmac_c2h_stream_0/mrmac_axis_rx_aclk] \
  [get_bd_pins mrmac_c2h_stream_1/mrmac_axis_rx_aclk]
  connect_bd_net -net mrmac_axis_tx_aclk_1  [get_bd_pins mrmac_25G_dual_0/mrmac_axis_tx_aclk_0_1] \
  [get_bd_pins mrmac_h2c_stream_0/mrmac_axis_tx_aclk] \
  [get_bd_pins mrmac_h2c_stream_1/mrmac_axis_tx_aclk]
  connect_bd_net -net mrmac_h2c_stream_0_tx_axis_tdata_lower  [get_bd_pins mrmac_h2c_stream_0/tx_axis_tdata_lower] \
  [get_bd_pins mrmac_25G_dual_0/tx_axis_tdata0]
  connect_bd_net -net mrmac_h2c_stream_0_tx_axis_tdata_upper  [get_bd_pins mrmac_h2c_stream_0/tx_axis_tdata_upper] \
  [get_bd_pins mrmac_25G_dual_0/tx_axis_tdata1]
  connect_bd_net -net mrmac_h2c_stream_0_tx_axis_tkeep_user_lower  [get_bd_pins mrmac_h2c_stream_0/tx_axis_tkeep_user_lower] \
  [get_bd_pins mrmac_25G_dual_0/tx_axis_tkeep_user0]
  connect_bd_net -net mrmac_h2c_stream_0_tx_axis_tlast  [get_bd_pins mrmac_h2c_stream_0/tx_axis_tlast] \
  [get_bd_pins mrmac_25G_dual_0/tx_axis_tlast_0]
  connect_bd_net -net mrmac_h2c_stream_0_tx_axis_tvalid  [get_bd_pins mrmac_h2c_stream_0/tx_axis_tvalid] \
  [get_bd_pins mrmac_25G_dual_0/tx_axis_tvalid_1]
  connect_bd_net -net mrmac_h2c_stream_1_tx_axis_tdata_lower  [get_bd_pins mrmac_h2c_stream_1/tx_axis_tdata_lower] \
  [get_bd_pins mrmac_25G_dual_0/tx_axis_tdata2]
  connect_bd_net -net mrmac_h2c_stream_1_tx_axis_tdata_upper  [get_bd_pins mrmac_h2c_stream_1/tx_axis_tdata_upper] \
  [get_bd_pins mrmac_25G_dual_0/tx_axis_tdata3]
  connect_bd_net -net mrmac_h2c_stream_1_tx_axis_tkeep_user_lower  [get_bd_pins mrmac_h2c_stream_1/tx_axis_tkeep_user_lower] \
  [get_bd_pins mrmac_25G_dual_0/tx_axis_tkeep_user2]
  connect_bd_net -net mrmac_h2c_stream_1_tx_axis_tkeep_user_upper  [get_bd_pins mrmac_h2c_stream_1/tx_axis_tkeep_user_upper] \
  [get_bd_pins mrmac_25G_dual_0/tx_axis_tkeep_user3]
  connect_bd_net -net mrmac_h2c_stream_1_tx_axis_tlast  [get_bd_pins mrmac_h2c_stream_1/tx_axis_tlast] \
  [get_bd_pins mrmac_25G_dual_0/tx_axis_tlast_1]
  connect_bd_net -net mrmac_h2c_stream_1_tx_axis_tvalid  [get_bd_pins mrmac_h2c_stream_1/tx_axis_tvalid] \
  [get_bd_pins mrmac_25G_dual_0/tx_axis_tvalid_0]
  connect_bd_net -net rx_axis_tdata_lower_1  [get_bd_pins mrmac_25G_dual_0/rx_axis_tdata0] \
  [get_bd_pins mrmac_c2h_stream_0/rx_axis_tdata_lower]
  connect_bd_net -net rx_axis_tdata_lower_2  [get_bd_pins mrmac_25G_dual_0/rx_axis_tdata2] \
  [get_bd_pins mrmac_c2h_stream_1/rx_axis_tdata_lower]
  connect_bd_net -net rx_axis_tdata_upper_1  [get_bd_pins mrmac_25G_dual_0/rx_axis_tdata1] \
  [get_bd_pins mrmac_c2h_stream_0/rx_axis_tdata_upper]
  connect_bd_net -net rx_axis_tdata_upper_2  [get_bd_pins mrmac_25G_dual_0/rx_axis_tdata3] \
  [get_bd_pins mrmac_c2h_stream_1/rx_axis_tdata_upper]
  connect_bd_net -net rx_axis_tkeep_user_lower_1  [get_bd_pins mrmac_25G_dual_0/rx_axis_tkeep_user0] \
  [get_bd_pins mrmac_c2h_stream_0/rx_axis_tkeep_user_lower]
  connect_bd_net -net rx_axis_tkeep_user_lower_2  [get_bd_pins mrmac_25G_dual_0/rx_axis_tkeep_user2] \
  [get_bd_pins mrmac_c2h_stream_1/rx_axis_tkeep_user_lower]
  connect_bd_net -net rx_axis_tkeep_user_upper_1  [get_bd_pins mrmac_25G_dual_0/rx_axis_tkeep_user3] \
  [get_bd_pins mrmac_c2h_stream_1/rx_axis_tkeep_user_upper]
  connect_bd_net -net sys_reset_1  [get_bd_ports PCIE_PERST] \
  [get_bd_pins xdma_0_support/sys_reset]
  connect_bd_net -net tx_axis_tkeep_user1_1  [get_bd_pins mrmac_h2c_stream_0/tx_axis_tkeep_user_upper] \
  [get_bd_pins mrmac_25G_dual_0/tx_axis_tkeep_user1]
  connect_bd_net -net tx_axis_tready_1  [get_bd_pins mrmac_25G_dual_0/tx_axis_tready_0] \
  [get_bd_pins mrmac_h2c_stream_0/tx_axis_tready]
  connect_bd_net -net tx_axis_tready_2  [get_bd_pins mrmac_25G_dual_0/tx_axis_tready_1] \
  ...
  [get_bd_pins mrmac_c2h_stream_1/xdma_axi_aclk]
  connect_bd_net -net xdma_0_axi_aresetn  [get_bd_pins xdma_0/axi_aresetn] \
  [get_bd_pins axi_gpio_0/s_axi_aresetn] \
  [get_bd_pins axi_smc/aresetn] \
  [get_bd_pins axi_iic_0/s_axi_aresetn] \
  [get_bd_pins mrmac_25G_dual_0/s_axi_aresetn] \
  [get_bd_pins mrmac_25G_dual_0/mrmac_resetn] \
  ...
  [get_bd_pins mrmac_c2h_stream_1/xdma_axis_aresetn]
  ...
  assign_bd_address -offset 0x00000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces xdma_0/M_AXI_LITE] [get_bd_addr_segs mrmac_25G_dual_0/mrmac_0/s_axi/Reg] -force
...
# End of cr_bd_VD100_25G_ether_dual()

cr_bd_VD100_25G_ether_dual ""
set_property REGISTERED_WITH_MANAGER "1" [get_files VD100_25G_ether_dual.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files VD100_25G_ether_dual.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list VD100_25G_ether_dual.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/VD100_25G_ether_dual/VD100_25G_ether_dual.gen/sources_1/bd/VD100_25G_ether_dual/hdl/VD100_25G_ether_dual_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list VD100_25G_ether_dual.bd]] -top]
  add_files -norecurse -fileset sources_1 $wrapper_path
}


generate_target all [get_files VD100_25G_ether_dual.bd]

create_ip_run [get_files VD100_25G_ether_dual.bd]

# Set 'mrmac_25G_dual_inst_0' fileset object
set obj [get_filesets mrmac_25G_dual_inst_0]
# Set 'mrmac_25G_dual_inst_0' fileset file properties for remote files
# None

# Set 'mrmac_25G_dual_inst_0' fileset file properties for local files
# None

# Set 'mrmac_25G_dual_inst_0' fileset properties
set obj [get_filesets mrmac_25G_dual_inst_0]
set_property -name "top" -value "mrmac_25G_dual_inst_0" -objects $obj
...
# Set 'mrmac_c2h_stream_inst_1' fileset object
set obj [get_filesets mrmac_c2h_stream_inst_1]
# Set 'mrmac_c2h_stream_inst_1' fileset file properties for remote files
# None

# Set 'mrmac_c2h_stream_inst_1' fileset file properties for local files
# None

# Set 'mrmac_c2h_stream_inst_1' fileset properties
set obj [get_filesets mrmac_c2h_stream_inst_1]
set_property -name "top" -value "mrmac_c2h_stream_inst_1" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
