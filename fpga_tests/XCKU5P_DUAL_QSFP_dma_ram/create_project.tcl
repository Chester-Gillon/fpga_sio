...
#
# create_project.tcl: Tcl script for re-creating project 'XCKU5P_DUAL_QSFP_dma_ram'
#
# Generated by Vivado on Sat Aug 17 15:39:38 BST 2024
...
set _xil_proj_name_ "XCKU5P_DUAL_QSFP_dma_ram"
...
set orig_proj_dir "[file normalize "$origin_dir/XCKU5P_DUAL_QSFP_dma_ram"]"
...
set_property -name "top" -value "XCKU5P_DUAL_QSFP_dma_ram_wrapper" -objects $obj
...
# Proc to create BD XCKU5P_DUAL_QSFP_dma_ram
proc cr_bd_XCKU5P_DUAL_QSFP_dma_ram { parentCell } {
...
# usr_accesse2_read
  ...
  set design_name XCKU5P_DUAL_QSFP_dma_ram
...
# End of cr_bd_XCKU5P_DUAL_QSFP_dma_ram()

cr_bd_XCKU5P_DUAL_QSFP_dma_ram ""
set_property REGISTERED_WITH_MANAGER "1" [get_files XCKU5P_DUAL_QSFP_dma_ram.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files XCKU5P_DUAL_QSFP_dma_ram.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list XCKU5P_DUAL_QSFP_dma_ram.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/XCKU5P_DUAL_QSFP_dma_ram/XCKU5P_DUAL_QSFP_dma_ram.gen/sources_1/bd/XCKU5P_DUAL_QSFP_dma_ram/hdl/XCKU5P_DUAL_QSFP_dma_ram_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list XCKU5P_DUAL_QSFP_dma_ram.bd]] -top]
