...
#
# create_project.tcl: Tcl script for re-creating project 'VD100_dma_stream_crc64'
#
# Generated by Vivado on Tue Dec 16 19:17:25 GMT 2025
...
set _xil_proj_name_ "VD100_dma_stream_crc64"
...
set orig_proj_dir "[file normalize "$origin_dir/VD100_dma_stream_crc64"]"
...
set_property -name "top" -value "VD100_dma_stream_crc64_wrapper" -objects $obj
...
# Proc to create BD VD100_dma_stream_crc64
proc cr_bd_VD100_dma_stream_crc64 { parentCell } {
# The design that will be created by this Tcl proc contains the following 
# module references:
# stream_crc, stream_crc, stream_crc, stream_crc



  # CHANGE DESIGN NAME HERE
  set design_name VD100_dma_stream_crc64
...
32 RX_REFCLK_FREQUENCY 100} \
    CONFIG.INTF0_PARENTID {VD100_dma_stream_crc64_pcie_phy_0} \
...
refclk_PROT0_R0_100_MHz_unique1} \
  ...
  connect_bd_intf_net -intf_net Conn8 [get_bd_intf_pins pcie/pcie_cfg_msi] [get_bd_intf_pins pcie_cfg_msi]
  ...
  connect_bd_intf_net -intf_net xdma_0_pcie4_cfg_msi [get_bd_intf_pins xdma_0/pcie4_cfg_msi] [get_bd_intf_pins xdma_0_support/pcie_cfg_msi]
...
# End of cr_bd_VD100_dma_stream_crc64()

cr_bd_VD100_dma_stream_crc64 ""
set_property REGISTERED_WITH_MANAGER "1" [get_files VD100_dma_stream_crc64.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files VD100_dma_stream_crc64.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list VD100_dma_stream_crc64.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/VD100_dma_stream_crc64/VD100_dma_stream_crc64.gen/sources_1/bd/VD100_dma_stream_crc64/hdl/VD100_dma_stream_crc64_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list VD100_dma_stream_crc64.bd]] -top]
