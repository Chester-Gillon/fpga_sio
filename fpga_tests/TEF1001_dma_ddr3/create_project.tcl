...
#
# Generated by Vivado on Sat Feb 24 17:34:20 GMT 2024
...
# End of write_mig_file_TEF1001_dma_ddr3_mig_7series_0_0()
  ...
  set_property CONFIG.NUM_MI {6} $xdma_0_axi_periph
  ...
  connect_bd_intf_net -intf_net xdma_0_axi_periph_M05_AXI [get_bd_intf_pins xdma_0_axi_periph/M05_AXI] [get_bd_intf_pins axi_gpio_2/S_AXI]
  ...
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins axi_interconnect_0/M00_ACLK]
  ...
  assign_bd_address -offset 0x00006000 -range 0x00002000 -target_address_space [get_bd_addr_spaces xdma_0/M_AXI_LITE] [get_bd_addr_segs axi_gpio_2/S_AXI/Reg] -force
...
if { [get_property IS_LOCKED [ get_files -norecurse [list TEF1001_dma_ddr3.bd]] ] == 1  } {
  ...
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list TEF1001_dma_ddr3.bd]] -top]
