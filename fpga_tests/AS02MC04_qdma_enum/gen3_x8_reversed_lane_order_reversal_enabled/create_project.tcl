...
#
# create_project.tcl: Tcl script for re-creating project 'AS02MC04_qdma_enum'
#
# Generated by Vivado on Sat May 16 18:27:43 BST 2026
...
#    "/home/mr_halfword/fpga_sio/fpga_tests/AS02MC04_qdma_enum/gen3_x8_reversed_lane_order_reversal_enabled/pcie.xdc"
...
set _xil_proj_name_ "AS02MC04_qdma_enum"
...
set orig_proj_dir "[file normalize "$origin_dir/AS02MC04_qdma_enum"]"
...
set_property -name "top" -value "AS02MC04_qdma_enum_wrapper" -objects $obj
...
# Proc to create BD AS02MC04_qdma_enum
proc cr_bd_AS02MC04_qdma_enum { parentCell } {
...
# usr_accesse2_read
  ...
  set design_name AS02MC04_qdma_enum
  ...
  connect_bd_net -net qdma_0_user_lnk_up  [get_bd_pins qdma_0/user_lnk_up] \
...
# End of cr_bd_AS02MC04_qdma_enum()

cr_bd_AS02MC04_qdma_enum ""
set_property REGISTERED_WITH_MANAGER "1" [get_files AS02MC04_qdma_enum.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files AS02MC04_qdma_enum.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list AS02MC04_qdma_enum.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/AS02MC04_qdma_enum/AS02MC04_qdma_enum.gen/sources_1/bd/AS02MC04_qdma_enum/hdl/AS02MC04_qdma_enum_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list AS02MC04_qdma_enum.bd]] -top]
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xcku3p-ffvb676-1-e -flow {Vivado Implementation 2025} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
