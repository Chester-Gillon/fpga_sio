...
#
# create_project.tcl: Tcl script for re-creating project 'NiteFury_axi_jtag'
#
# Generated by Vivado on Thu Dec 19 16:37:11 GMT 2024
...
#    "/home/mr_halfword/fpga_sio/fpga_tests/NiteFury_axi_jtag/ddr3_clk.xdc"
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/ddr3_clk.xdc"]"\
...
set _xil_proj_name_ "NiteFury_axi_jtag"
...
set orig_proj_dir "[file normalize "$origin_dir/NiteFury_axi_jtag"]"
...
set_property -name "top" -value "NiteFury_axi_jtag_wrapper" -objects $obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/ddr3_clk.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/ddr3_clk.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
...
# Proc to create BD NiteFury_axi_jtag
proc cr_bd_NiteFury_axi_jtag { parentCell } {
...
# usr_accesse2_read
  ...
  set design_name NiteFury_axi_jtag
  ...
  connect_bd_intf_net -intf_net CLK_DDR3_200MHz_clk_1 [get_bd_intf_ports CLK_DDR3_200MHz] [get_bd_intf_pins clk_wiz/CLK_IN1_D]
  ...
  assign_bd_address -offset 0x00000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces jtag_axi_0/Data] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] -force
...
# End of cr_bd_NiteFury_axi_jtag()

cr_bd_NiteFury_axi_jtag ""
set_property REGISTERED_WITH_MANAGER "1" [get_files NiteFury_axi_jtag.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files NiteFury_axi_jtag.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list NiteFury_axi_jtag.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/NiteFury_axi_jtag/NiteFury_axi_jtag.gen/sources_1/bd/NiteFury_axi_jtag/hdl/NiteFury_axi_jtag_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list NiteFury_axi_jtag.bd]] -top]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7a200tfbg484-2 -flow {Vivado Synthesis 2024} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7a200tfbg484-2 -flow {Vivado Implementation 2024} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
