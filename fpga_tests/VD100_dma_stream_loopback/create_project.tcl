...
#
# create_project.tcl: Tcl script for re-creating project 'VD100_dma_stream_loopback'
#
# Generated by Vivado on Sat Feb 07 22:17:32 GMT 2026
...
set _xil_proj_name_ "VD100_dma_stream_loopback"
...
set orig_proj_dir "[file normalize "$origin_dir/VD100_dma_stream_loopback"]"
...
set_property -name "top" -value "VD100_dma_stream_loopback_wrapper" -objects $obj
...
# Proc to create BD VD100_dma_stream_loopback
proc cr_bd_VD100_dma_stream_loopback { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name VD100_dma_stream_loopback
...
32 RX_REFCLK_FREQUENCY 100} \
    CONFIG.INTF0_PARENTID {VD100_dma_stream_loopback_pcie_phy_0} \
...
refclk_PROT0_R0_100_MHz_unique1} \
  ...
  connect_bd_intf_net -intf_net xdma_0_M_AXI_LITE [get_bd_intf_pins axis_switch_0/S_AXI_CTRL] [get_bd_intf_pins xdma_0/M_AXI_LITE]
  ...
  connect_bd_net -net [get_bd_nets BUFG_GT_CE_1]  [get_bd_pins xdma_0_support/gtpowergood] \
  ...
  assign_bd_address -offset 0x00000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces xdma_0/M_AXI_LITE] [get_bd_addr_segs axis_switch_0/S_AXI_CTRL/Reg] -force
...
# End of cr_bd_VD100_dma_stream_loopback()

cr_bd_VD100_dma_stream_loopback ""
set_property REGISTERED_WITH_MANAGER "1" [get_files VD100_dma_stream_loopback.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files VD100_dma_stream_loopback.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list VD100_dma_stream_loopback.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/VD100_dma_stream_loopback/VD100_dma_stream_loopback.gen/sources_1/bd/VD100_dma_stream_loopback/hdl/VD100_dma_stream_loopback_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list VD100_dma_stream_loopback.bd]] -top]
...
set_property -name "steps.write_device_image.args.mask_file" -value "1" -objects $obj
