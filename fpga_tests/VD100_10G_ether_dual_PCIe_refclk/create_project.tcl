...
#
# create_project.tcl: Tcl script for re-creating project 'VD100_10G_ether_dual_PCIe_refclk'
#
# Generated by Vivado on Sun May 24 18:10:08 BST 2026
...
set _xil_proj_name_ "VD100_10G_ether_dual_PCIe_refclk"
...
set orig_proj_dir "[file normalize "$origin_dir/VD100_10G_ether_dual_PCIe_refclk"]"
...
set_property -name "top" -value "VD100_10G_ether_dual_PCIe_refclk_wrapper" -objects $obj
...
proc cr_bd_mrmac_10G_dual { parentCell } {
  ...
  set GTREFCLK0 [ create_bd_port -dir I -type clk -freq_hz 100000000 GTREFCLK0 ]
...
/gt_quad_base/RX0_GT_IP_Interface mrmac_10G_dual_mrmac_0_0_0./mrmac_0/gt_rx_serdes_interface_0.0 /gt_quad_base/RX1_GT_IP_Interface mrmac_10G_dual_mrmac_0_0_1./mrmac_0/gt_rx_serdes_interface_1.1} \
    ...
    CONFIG.PROT0_LR0_SETTINGS {PRESET None RX_PAM_SEL NRZ TX_PAM_SEL NRZ TX_HD_EN 0 RX_HD_EN 0 RX_GRAY_BYP true TX_GRAY_BYP true RX_GRAY_LITTLEENDIAN true TX_GRAY_LITTLEENDIAN true RX_PRECODE_BYP true\
TX_PRECODE_BYP true RX_PRECODE_LITTLEENDIAN false TX_PRECODE_LITTLEENDIAN false INTERNAL_PRESET None GT_TYPE GTYP GT_DIRECTION DUPLEX XPU_MODE 0 TX_LINE_RATE 10.3125 TX_PLL_TYPE LCPLL TX_REFCLK_FREQUENCY\
100 TX_ACTUAL_REFCLK_FREQUENCY 100.000000000000 TX_FRACN_ENABLED true TX_FRACN_OVRD false TX_FRACN_NUMERATOR 0 TX_REFCLK_SOURCE R0 TX_DATA_ENCODING RAW TX_USER_DATA_WIDTH 32 TX_INT_DATA_WIDTH 32 TX_BUFFER_MODE\
...
false TX_64B66B_ENCODER false TX_64B66B_CRC false TX_RATE_GROUP A RX_LINE_RATE 10.3125 RX_PLL_TYPE LCPLL RX_REFCLK_FREQUENCY 100 RX_ACTUAL_REFCLK_FREQUENCY 100.000000000000 RX_FRACN_ENABLED true RX_FRACN_OVRD\
false RX_FRACN_NUMERATOR 0 RX_REFCLK_SOURCE R0 RX_DATA_DECODING RAW RX_USER_DATA_WIDTH 32 RX_INT_DATA_WIDTH 32 RX_BUFFER_MODE 1 RX_OUTCLK_SOURCE RXPROGDIVCLK RXPROGDIV_FREQ_ENABLE true RXPROGDIV_FREQ_SOURCE\
...
{/gt_quad_base mrmac_10G_dual_mrmac_0_0_0.IP_CH0,mrmac_10G_dual_mrmac_0_0_1.IP_CH1,undef,undef MSTRCLK 1,1,0,0 IS_CURRENT_QUAD 1}}} \
    CONFIG.REFCLK_LIST {/GTREFCLK0} \
    CONFIG.REFCLK_STRING {HSCLK0_LCPLLGTREFCLK0 refclk_PROT0_R0_PROT1_R0_100_MHz_unique1} \
  ...
  connect_bd_net -net GTREFCLK0_1  [get_bd_ports GTREFCLK0] \
...
proc cr_bd_mrmac_c2h_stream { parentCell } {
  ...
  # Create ports
  set xdma_axi_aclk [ create_bd_port -dir I -type clk -freq_hz 250000000 xdma_axi_aclk ]
  set mrmac_axis_tx_aclk [ create_bd_port -dir I -type clk -freq_hz 322265000 mrmac_axis_tx_aclk ]
  set xdma_axis_aresetn [ create_bd_port -dir I -type rst xdma_axis_aresetn ]
  set rx_axis_tdata [ create_bd_port -dir I -from 63 -to 0 rx_axis_tdata ]
  set rx_axis_tlast [ create_bd_port -dir I rx_axis_tlast ]
  set rx_axis_tvalid [ create_bd_port -dir I rx_axis_tvalid ]
  set rx_axis_tkeep_user [ create_bd_port -dir I -from 10 -to 0 rx_axis_tkeep_user ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins axis_dwidth_converter_0/S_AXIS] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
  connect_bd_intf_net -intf_net axis_data_fifo_1_M_AXIS [get_bd_intf_pins axis_data_fifo_1/M_AXIS] [get_bd_intf_ports C2H_AXIS]
  ...
  [get_bd_pins axis_data_fifo_0/s_axis_aresetn] \
  [get_bd_pins axis_data_fifo_1/s_axis_aresetn]
  connect_bd_net -net rx_axis_tdata_1  [get_bd_ports rx_axis_tdata] \
  [get_bd_pins ilslice_0/Din]
  connect_bd_net -net rx_axis_tkeep_user_1  [get_bd_ports rx_axis_tkeep_user] \
...
# Proc to create BD VD100_10G_ether_dual_PCIe_refclk
proc cr_bd_VD100_10G_ether_dual_PCIe_refclk { parentCell } {
# The design that will be created by this Tcl proc contains the following 
# block design container source references:
# mrmac_10G_dual, mrmac_h2c_stream, mrmac_c2h_stream



  # CHANGE DESIGN NAME HERE
  set design_name VD100_10G_ether_dual_PCIe_refclk
  ...
  ##################################################################
  set bCheckSources 1
  set list_bdc_active "mrmac_10G_dual, mrmac_h2c_stream, mrmac_c2h_stream"
...
proc create_hier_cell_xdma_0_support { parentCell nameHier } {
  ...
  create_bd_pin -dir O -from 0 -to 0 pcie_refclk_ibuf_out
...
LCPLL RX_SLIDE_MODE OFF RX_REFCLK_SOURCE R0 RX_OUTCLK_SOURCE RXOUTCLKPMA RX_EQ_MODE LPM RX_SSC_PPM 0 INS_LOSS_NYQ 20 RX_DATA_DECODING 8B10B RX_LINE_RATE 2.5 RX_PPM_OFFSET 600 RX_USER_DATA_WIDTH 16 RX_INT_DATA_WIDTH\
...
250 OOB_ENABLE true RX_BUFFER_MODE 1 RXPROGDIV_FREQ_ENABLE false RX_CC_LEN_SEQ 1 RX_CC_NUM_SEQ 1 RX_CC_K_0_0 true RX_CC_MASK_0_0 false RX_CC_VAL_0_0 00011100 RX_CC_KEEP_IDLE ENABLE RX_COMMA_ALIGN_WORD\
1 RX_COMMA_PRESET K28.5 RX_COMMA_M_ENABLE true RX_COMMA_P_ENABLE true RX_COMMA_MASK 1111111111 RX_COMMA_M_VAL 0101111100 RX_COMMA_P_VAL 1010000011 RX_COMMA_DOUBLE_ENABLE false RX_JTOL_FC 1 RX_PLL_TYPE\
LCPLL RX_SLIDE_MODE OFF RX_REFCLK_SOURCE R0 RX_OUTCLK_SOURCE RXOUTCLKPMA RX_EQ_MODE LPM RX_SSC_PPM 0 INS_LOSS_NYQ 20 RX_DATA_DECODING 8B10B RX_LINE_RATE 5.0 RX_PPM_OFFSET 600 RX_USER_DATA_WIDTH 16 RX_INT_DATA_WIDTH\
20 RX_REFCLK_FREQUENCY 100} \
...
250 OOB_ENABLE true RX_BUFFER_MODE 1 RXPROGDIV_FREQ_ENABLE false RX_CC_LEN_SEQ 1 RX_CC_NUM_SEQ 1 RX_CC_K_0_0 true RX_CC_MASK_0_0 false RX_CC_VAL_0_0 00011100 RX_CC_KEEP_IDLE ENABLE RX_COMMA_ALIGN_WORD\
1 RX_COMMA_PRESET K28.5 RX_COMMA_M_ENABLE true RX_COMMA_P_ENABLE true RX_COMMA_MASK 1111111111 RX_COMMA_M_VAL 0101111100 RX_COMMA_P_VAL 1010000011 RX_COMMA_DOUBLE_ENABLE false RX_JTOL_FC 1 RX_PLL_TYPE\
LCPLL RX_SLIDE_MODE OFF RX_REFCLK_SOURCE R0 RX_OUTCLK_SOURCE RXOUTCLKPMA RX_EQ_MODE DFE RX_SSC_PPM 0 INS_LOSS_NYQ 20 RX_DATA_DECODING 128B130B RX_LINE_RATE 8.0 RX_PPM_OFFSET 600 RX_USER_DATA_WIDTH 32 RX_INT_DATA_WIDTH\
...
250 OOB_ENABLE true RX_BUFFER_MODE 1 RXPROGDIV_FREQ_ENABLE false RX_CC_LEN_SEQ 1 RX_CC_NUM_SEQ 1 RX_CC_K_0_0 true RX_CC_MASK_0_0 false RX_CC_VAL_0_0 00011100 RX_CC_KEEP_IDLE ENABLE RX_COMMA_ALIGN_WORD\
1 RX_COMMA_PRESET K28.5 RX_COMMA_M_ENABLE true RX_COMMA_P_ENABLE true RX_COMMA_MASK 1111111111 RX_COMMA_M_VAL 0101111100 RX_COMMA_P_VAL 1010000011 RX_COMMA_DOUBLE_ENABLE false RX_JTOL_FC 1 RX_PLL_TYPE\
LCPLL RX_SLIDE_MODE OFF RX_REFCLK_SOURCE R0 RX_OUTCLK_SOURCE RXOUTCLKPMA RX_EQ_MODE DFE RX_SSC_PPM 0 INS_LOSS_NYQ 20 RX_DATA_DECODING 128B130B RX_LINE_RATE 16.0 RX_PPM_OFFSET 600 RX_USER_DATA_WIDTH 32\
RX_INT_DATA_WIDTH 32 RX_REFCLK_FREQUENCY 100} \
    CONFIG.INTF0_PARENTID {VD100_10G_ether_dual_PCIe_refclk_pcie_phy_0} \
...
refclk_PROT0_R0_100_MHz_unique1} \
  ...
  [get_bd_pins pcie_refclk_ibuf_out]
  ...
  connect_bd_intf_net -intf_net mrmac_c2h_stream_1_C2H_AXIS [get_bd_intf_pins xdma_0/S_AXIS_C2H_1] [get_bd_intf_pins mrmac_c2h_stream_1/C2H_AXIS]
  ...
  # Create port connections
  connect_bd_net -net GTREFCLK0_1  [get_bd_pins xdma_0_support/pcie_refclk_ibuf_out] \
  [get_bd_pins mrmac_10G_dual_0/GTREFCLK0]
  ...
  connect_bd_net -net mrmac_10G_dual_0_mrmac_axis_rx_aclk_0_1  [get_bd_pins mrmac_10G_dual_0/mrmac_axis_rx_aclk_0_1] \
  [get_bd_pins mrmac_c2h_stream_0/mrmac_axis_tx_aclk] \
  [get_bd_pins mrmac_c2h_stream_1/mrmac_axis_tx_aclk]
  ...
  connect_bd_net -net mrmac_10G_dual_0_rx_axis_tdata0  [get_bd_pins mrmac_10G_dual_0/rx_axis_tdata0] \
  [get_bd_pins mrmac_c2h_stream_0/rx_axis_tdata]
  connect_bd_net -net mrmac_10G_dual_0_rx_axis_tdata2  [get_bd_pins mrmac_10G_dual_0/rx_axis_tdata2] \
  [get_bd_pins mrmac_c2h_stream_1/rx_axis_tdata]
  connect_bd_net -net mrmac_10G_dual_0_rx_axis_tkeep_user2  [get_bd_pins mrmac_10G_dual_0/rx_axis_tkeep_user2] \
  [get_bd_pins mrmac_c2h_stream_1/rx_axis_tkeep_user]
  connect_bd_net -net mrmac_10G_dual_0_rx_axis_tlast_0  [get_bd_pins mrmac_10G_dual_0/rx_axis_tlast_0] \
  ...
  connect_bd_net -net rx_axis_tkeep_user_1  [get_bd_pins mrmac_10G_dual_0/rx_axis_tkeep_user0] \
  [get_bd_pins mrmac_c2h_stream_0/rx_axis_tkeep_user]
  connect_bd_net -net rx_axis_tlast_1  [get_bd_pins mrmac_10G_dual_0/rx_axis_tlast_1] \
  [get_bd_pins mrmac_c2h_stream_1/rx_axis_tlast]
  connect_bd_net -net rx_axis_tvalid_1  [get_bd_pins mrmac_10G_dual_0/rx_axis_tvalid_0] \
  [get_bd_pins mrmac_c2h_stream_0/rx_axis_tvalid]
  connect_bd_net -net rx_axis_tvalid_2  [get_bd_pins mrmac_10G_dual_0/rx_axis_tvalid_1] \
...
# End of cr_bd_VD100_10G_ether_dual_PCIe_refclk()

cr_bd_VD100_10G_ether_dual_PCIe_refclk ""
set_property REGISTERED_WITH_MANAGER "1" [get_files VD100_10G_ether_dual_PCIe_refclk.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files VD100_10G_ether_dual_PCIe_refclk.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list VD100_10G_ether_dual_PCIe_refclk.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/VD100_10G_ether_dual_PCIe_refclk/VD100_10G_ether_dual_PCIe_refclk.gen/sources_1/bd/VD100_10G_ether_dual_PCIe_refclk/hdl/VD100_10G_ether_dual_PCIe_refclk_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list VD100_10G_ether_dual_PCIe_refclk.bd]] -top]
  add_files -norecurse -fileset sources_1 $wrapper_path
}


generate_target all [get_files VD100_10G_ether_dual_PCIe_refclk.bd]

create_ip_run [get_files VD100_10G_ether_dual_PCIe_refclk.bd]
