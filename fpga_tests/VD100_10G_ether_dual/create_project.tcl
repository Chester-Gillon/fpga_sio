...
#
# Generated by Vivado on Sun Feb 01 16:15:12 GMT 2026
...
# Proc to create BD mrac_10G_dual
proc cr_bd_mrac_10G_dual { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name mrac_10G_dual
  ...
  set mrmac_axis_tx_aclk_1 [ create_bd_port -dir O -from 0 -to 0 -type clk mrmac_axis_tx_aclk_1 ]
  set mrmac_axis_tx_aclk_0 [ create_bd_port -dir O -from 0 -to 0 -type clk mrmac_axis_tx_aclk_0 ]
  ...
  set_property -dict [list \
    ...
    CONFIG.MRMAC_DATA_PATH_INTERFACE_PORT0_C0 {Low Latency 32b  Non-Segmented} \
    CONFIG.MRMAC_DATA_PATH_INTERFACE_PORT1_C0 {Low Latency 32b  Non-Segmented} \
  ...
  set_property -dict [list \
    ...
    CONFIG.CHANNEL_ORDERING {/gt_quad_base/TX0_GT_IP_Interface mrac_10G_dual_mrmac_0_0_0./mrmac_0/gt_tx_serdes_interface_0.0 /gt_quad_base/TX1_GT_IP_Interface mrac_10G_dual_mrmac_0_0_1./mrmac_0/gt_tx_serdes_interface_1.1\
/gt_quad_base/RX0_GT_IP_Interface mrac_10G_dual_mrmac_0_0_0./mrmac_0/gt_rx_serdes_interface_0.0 /gt_quad_base/RX1_GT_IP_Interface mrac_10G_dual_mrmac_0_0_1./mrmac_0/gt_rx_serdes_interface_1.1} \
    CONFIG.GT_TYPE {GTYP} \
...
RX_BUFFER_RESET_ON_RATE_CHANGE ENABLE RESET_SEQUENCE_INTERVAL 0 RX_COMMA_PRESET NONE RX_COMMA_VALID_ONLY 0 GT_TYPE GTYP} \
    ...
    CONFIG.QUAD_USAGE {TX_QUAD_CH {TXQuad_0_/gt_quad_base {/gt_quad_base mrac_10G_dual_mrmac_0_0_0.IP_CH0,mrac_10G_dual_mrmac_0_0_1.IP_CH1,undef,undef MSTRCLK 1,1,0,0 IS_CURRENT_QUAD 1}} RX_QUAD_CH {RXQuad_0_/gt_quad_base\
{/gt_quad_base mrac_10G_dual_mrmac_0_0_0.IP_CH0,mrac_10G_dual_mrmac_0_0_1.IP_CH1,undef,undef MSTRCLK 1,1,0,0 IS_CURRENT_QUAD 1}}} \
  ...
  [get_bd_ports mrmac_axis_tx_aclk_1]
  ...
  [get_bd_ports mrmac_axis_tx_aclk_0]
...
# End of cr_bd_mrac_10G_dual()

cr_bd_mrac_10G_dual ""
set_property REGISTERED_WITH_MANAGER "1" [get_files mrac_10G_dual.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files mrac_10G_dual.bd ] 
...
# mrac_10G_dual, mrmac_h2c_stream
  ...
  ##################################################################
  set bCheckSources 1
  set list_bdc_active "mrac_10G_dual, mrmac_h2c_stream"
...
refclk_PROT0_R0_100_MHz_unique1} \
  ...
  # Create instance: mrac_10G_dual_0, and set properties
  set mrac_10G_dual_0 [ create_bd_cell -type container -reference mrac_10G_dual mrac_10G_dual_0 ]
  set_property -dict [list \
    CONFIG.ACTIVE_SIM_BD {mrac_10G_dual.bd} \
    CONFIG.ACTIVE_SYNTH_BD {mrac_10G_dual.bd} \
    CONFIG.ENABLE_DFX {0} \
    CONFIG.LIST_SIM_BD {mrac_10G_dual.bd} \
    CONFIG.LIST_SYNTH_BD {mrac_10G_dual.bd} \
    CONFIG.LOCK_PROPAGATE {0} \
  ] $mrac_10G_dual_0


  set_property SELECTED_SIM_MODEL rtl  $mrac_10G_dual_0
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net SFP_REF_1 [get_bd_intf_pins mrac_10G_dual_0/SFP_REF] [get_bd_intf_ports SFP_REF]
  ...
  connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins axi_smc/M02_AXI] [get_bd_intf_pins mrac_10G_dual_0/s_axi]
  connect_bd_intf_net -intf_net mrac_10G_dual_0_SFP_serial [get_bd_intf_pins mrac_10G_dual_0/SFP_serial] [get_bd_intf_ports SFP_serial]
  ...
  connect_bd_net -net mrac_10G_dual_0_mrmac_axis_tx_aclk_0  [get_bd_pins mrac_10G_dual_0/mrmac_axis_tx_aclk_0] \
  [get_bd_pins mrmac_h2c_stream_0/mrmac_axis_tx_aclk]
  connect_bd_net -net mrac_10G_dual_0_mrmac_axis_tx_aclk_1  [get_bd_pins mrac_10G_dual_0/mrmac_axis_tx_aclk_1] \
  [get_bd_pins mrmac_h2c_stream_1/mrmac_axis_tx_aclk]
  connect_bd_net -net mrac_10G_dual_0_tx_axis_tready_0  [get_bd_pins mrac_10G_dual_0/tx_axis_tready_0] \
  ...
  [get_bd_pins mrac_10G_dual_0/s_axi_aresetn] \
  [get_bd_pins mrac_10G_dual_0/mrmac_resetn] \
  ...
  assign_bd_address -offset 0x00000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces xdma_0/M_AXI_LITE] [get_bd_addr_segs mrac_10G_dual_0/mrmac_0/s_axi/Reg] -force
...
# Proc to create BD mrac_h2c_stream_inst_0
proc cr_bd_mrac_h2c_stream_inst_0 { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name mrac_h2c_stream_inst_0

  common::send_gid_msg -ssname BD::TCL -id 2010 -severity "INFO" "Currently there is no design <$design_name> in project, so creating one..."

  create_bd_design -bdsource /home/mr_halfword/fpga_sio/fpga_tests/VD100_10G_ether_dual/VD100_10G_ether_dual/VD100_10G_ether_dual.srcs/sources_1/bd/mrac_h2c_stream/mrac_h2c_stream.bd $design_name
  ...
  # Create ports
  set xdma_axi_aclk [ create_bd_port -dir I -type clk xdma_axi_aclk ]
  set_property -dict [ list \
   CONFIG.ASSOCIATED_BUSIF {H2C_AXIS} \
   CONFIG.ASSOCIATED_CLKEN {s_axis_aclken} \
   CONFIG.ASSOCIATED_RESET {xdma_axis_aresetn:s_axi_aresetn} \
   CONFIG.FREQ_TOLERANCE_HZ {0} \
   CONFIG.INSERT_VIP {0} \
 ] $xdma_axi_aclk
  set_property CONFIG.ASSOCIATED_BUSIF.VALUE_SRC STRONG $xdma_axi_aclk
  set_property CONFIG.ASSOCIATED_CLKEN.VALUE_SRC STRONG $xdma_axi_aclk
  set_property CONFIG.ASSOCIATED_RESET.VALUE_SRC STRONG $xdma_axi_aclk
  set_property CONFIG.FREQ_TOLERANCE_HZ.VALUE_SRC STRONG $xdma_axi_aclk
  set_property CONFIG.INSERT_VIP.VALUE_SRC STRONG $xdma_axi_aclk

  set xdma_axis_aresetn [ create_bd_port -dir I -type rst xdma_axis_aresetn ]
  set_property -dict [ list \
   CONFIG.INSERT_VIP {0} \
 ] $xdma_axis_aresetn
  set_property CONFIG.INSERT_VIP.VALUE_SRC STRONG $xdma_axis_aresetn

  set mrmac_axis_tx_aclk [ create_bd_port -dir I -type clk mrmac_axis_tx_aclk ]
  set_property -dict [ list \
  ...
  set_property CONFIG.ASSOCIATED_CLKEN.VALUE_SRC STRONG $mrmac_axis_tx_aclk
  set_property CONFIG.ASSOCIATED_RESET.VALUE_SRC STRONG $mrmac_axis_tx_aclk
  set_property CONFIG.FREQ_TOLERANCE_HZ.VALUE_SRC STRONG $mrmac_axis_tx_aclk
  set_property CONFIG.INSERT_VIP.VALUE_SRC STRONG $mrmac_axis_tx_aclk
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"0.860087",
   "Default View_TopLeft":"-183,-2",
   "ExpandedHierarchyInLayout":"",
   "guistr":"# # String gsaved with Nlview 7.8.0 2024-04-26 e1825d835c VDI=44 GEI=38 GUI=JA:21.0 TLS
#  -string -flagsOSRD
preplace port H2C_AXIS -pg 1 -lvl 0 -x 0 -y 70 -defaultsOSRD
preplace port port-id_xdma_axi_aclk -pg 1 -lvl 0 -x 0 -y 100 -defaultsOSRD
preplace port port-id_xdma_axis_aresetn -pg 1 -lvl 0 -x 0 -y 0 -defaultsOSRD
preplace port port-id_mrmac_axis_tx_aclk -pg 1 -lvl 0 -x 0 -y 130 -defaultsOSRD
preplace inst axis_data_fifo_0 -pg 1 -lvl 1 -x 200 -y 90 -defaultsOSRD
preplace inst axis_dwidth_converter_0 -pg 1 -lvl 2 -x 570 -y 110 -defaultsOSRD
preplace inst axis_data_fifo_1 -pg 1 -lvl 1 -x 200 -y 340 -defaultsOSRD
preplace inst proc_sys_reset_0 -pg 1 -lvl 2 -x 570 -y 300 -defaultsOSRD
preplace netloc xdma_axi_aclk_1 1 0 1 N 100
preplace netloc mrmac_axis_tx_aclk_1 1 0 2 20 180 390
preplace netloc axis_aresetn_1 1 0 2 30 -10 350
preplace netloc proc_sys_reset_0_interconnect_aresetn 1 0 3 40 200 380 200 750
preplace netloc axis_data_fifo_0_M_AXIS 1 1 1 N 90
preplace netloc axis_dwidth_converter_0_M_AXIS 1 0 3 50 0 NJ 0 750
preplace netloc H2C_AXIS_1 1 0 1 20 60n
levelinfo -pg 1 0 200 570 770
pagesize -pg 1 -db -bbox -sgen -190 -20 800 520
"
}
...
# End of cr_bd_mrac_h2c_stream_inst_0()

cr_bd_mrac_h2c_stream_inst_0 ""
set_property REGISTERED_WITH_MANAGER "1" [get_files mrac_h2c_stream_inst_0.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files mrac_h2c_stream_inst_0.bd ] 
...
# Set 'mrac_10G_dual_inst_0' fileset object
set obj [get_filesets mrac_10G_dual_inst_0]
# Set 'mrac_10G_dual_inst_0' fileset file properties for remote files
# None

# Set 'mrac_10G_dual_inst_0' fileset file properties for local files
# None

# Set 'mrac_10G_dual_inst_0' fileset properties
set obj [get_filesets mrac_10G_dual_inst_0]
set_property -name "top" -value "mrac_10G_dual_inst_0" -objects $obj
