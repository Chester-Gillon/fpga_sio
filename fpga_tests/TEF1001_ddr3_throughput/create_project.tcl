...
#
# create_project.tcl: Tcl script for re-creating project 'TEF1001_ddr3_throughput'
#
# Generated by Vivado on Sat Jan 04 16:06:41 GMT 2025
...
set _xil_proj_name_ "TEF1001_ddr3_throughput"
...
set orig_proj_dir "[file normalize "$origin_dir/TEF1001_ddr3_throughput"]"
...
set_property -name "top" -value "TEF1001_ddr3_throughput_wrapper" -objects $obj
...
# Proc to create BD TEF1001_ddr3_throughput
proc cr_bd_TEF1001_ddr3_throughput { parentCell } {
# The design that will be created by this Tcl proc contains the following 
# module references:
# usr_accesse2_read, axi_stream_sink, axi_stream_source_fixed_data



  # CHANGE DESIGN NAME HERE
  set design_name TEF1001_ddr3_throughput
...
proc write_mig_file_TEF1001_ddr3_throughput_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {  <ModuleName>TEF1001_ddr3_throughput_mig_7series_0_0</ModuleName>}
...
# End of write_mig_file_TEF1001_ddr3_throughput_mig_7series_0_0()
  ...
  write_mig_file_TEF1001_ddr3_throughput_mig_7series_0_0 $str_mig_file_path
  ...
  if { [catch {set axi_stream_sink_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.TDATA_NUM_BYTES {64} $axi_stream_sink_0
  ...
  if { [catch {set axi_stream_source_fi_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.TDATA_NUM_BYTES {64} $axi_stream_source_fi_0
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_stream_sink_0/interface_axis] [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net axi_pcie_0_M_AXI [get_bd_intf_pins axi_pcie_0/M_AXI] [get_bd_intf_pins axi_smc/S00_AXI]
  ...
  connect_bd_intf_net -intf_net axi_stream_source_fi_0_interface_axis [get_bd_intf_pins axi_stream_source_fi_0/interface_axis] [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM]
  ...
  connect_bd_net -net xdma_0_axi_aresetn  [get_bd_pins axi_pcie_0/user_link_up] \
  ...
  assign_bd_address -offset 0x00002000 -range 0x00002000 -target_address_space [get_bd_addr_spaces axi_pcie_0/M_AXI] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] -force
  assign_bd_address -offset 0x00001000 -range 0x00001000 -target_address_space [get_bd_addr_spaces axi_pcie_0/M_AXI] [get_bd_addr_segs axi_gpio_1/S_AXI/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces axi_pcie_0/M_AXI] [get_bd_addr_segs xadc_wiz_0/s_axi_lite/Reg] -force
  assign_bd_address -offset 0x00000000 -range 0x000200000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_MM2S] [get_bd_addr_segs mig_7series_0/memmap/memaddr] -force
  assign_bd_address -offset 0x00000000 -range 0x000200000000 -target_address_space [get_bd_addr_spaces axi_dma_0/Data_S2MM] [get_bd_addr_segs mig_7series_0/memmap/memaddr] -force
...
# End of cr_bd_TEF1001_ddr3_throughput()

cr_bd_TEF1001_ddr3_throughput ""
set_property REGISTERED_WITH_MANAGER "1" [get_files TEF1001_ddr3_throughput.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files TEF1001_ddr3_throughput.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list TEF1001_ddr3_throughput.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/TEF1001_ddr3_throughput/TEF1001_ddr3_throughput.gen/sources_1/bd/TEF1001_ddr3_throughput/hdl/TEF1001_ddr3_throughput_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list TEF1001_ddr3_throughput.bd]] -top]
