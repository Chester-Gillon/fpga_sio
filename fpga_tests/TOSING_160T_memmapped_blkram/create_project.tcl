...
#
# create_project.tcl: Tcl script for re-creating project 'TOSING_160T_memmapped_blkram'
#
# Generated by Vivado on Thu Mar 28 21:06:31 GMT 2024
...
set _xil_proj_name_ "TOSING_160T_memmapped_blkram"
...
set orig_proj_dir "[file normalize "$origin_dir/TOSING_160T_memmapped_blkram"]"
...
set_property -name "top" -value "TOSING_160T_memmapped_blkram_wrapper" -objects $obj
...
# Proc to create BD TOSING_160T_memmapped_blkram
proc cr_bd_TOSING_160T_memmapped_blkram { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name TOSING_160T_memmapped_blkram
  ...
  set_property CONFIG.DATA_WIDTH {128} $axi_bram_ctrl_1
  ...
  set_property CONFIG.DATA_WIDTH {128} $axi_bram_ctrl_2
  ...
  connect_bd_net -net axi_pcie_0_axi_aclk_out [get_bd_pins axi_pcie_0/axi_aclk_out] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_bram_ctrl_2/s_axi_aclk]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins axi_pcie_0/axi_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_2/s_axi_aresetn]
...
# End of cr_bd_TOSING_160T_memmapped_blkram()

cr_bd_TOSING_160T_memmapped_blkram ""
set_property REGISTERED_WITH_MANAGER "1" [get_files TOSING_160T_memmapped_blkram.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files TOSING_160T_memmapped_blkram.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list TOSING_160T_memmapped_blkram.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/TOSING_160T_memmapped_blkram/TOSING_160T_memmapped_blkram.gen/sources_1/bd/TOSING_160T_memmapped_blkram/hdl/TOSING_160T_memmapped_blkram_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list TOSING_160T_memmapped_blkram.bd]] -top]
