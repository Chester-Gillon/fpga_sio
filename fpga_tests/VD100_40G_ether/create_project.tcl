...
#
# create_project.tcl: Tcl script for re-creating project 'VD100_40G_ether'
#
# Generated by Vivado on Mon May 25 21:19:39 BST 2026
...
set _xil_proj_name_ "VD100_40G_ether"
...
set orig_proj_dir "[file normalize "$origin_dir/VD100_40G_ether"]"
...
set_property -name "top" -value "VD100_40G_ether_wrapper" -objects $obj
...
proc cr_bd_mrmac_h2c_stream { parentCell } {
  ...
  set mrmac_axis_tx_aclk [ create_bd_port -dir I -type clk -freq_hz 322265500 mrmac_axis_tx_aclk ]
  set xdma_axis_aresetn [ create_bd_port -dir I -type rst xdma_axis_aresetn ]
  set tx_axis_tdata0 [ create_bd_port -dir O -from 63 -to 0 -type data tx_axis_tdata0 ]
  set tx_axis_tdata1 [ create_bd_port -dir O -from 63 -to 0 -type data tx_axis_tdata1 ]
  set tx_axis_tdata2 [ create_bd_port -dir O -from 63 -to 0 -type data tx_axis_tdata2 ]
  set tx_axis_tdata3 [ create_bd_port -dir O -from 63 -to 0 -type data tx_axis_tdata3 ]
  set tx_axis_tkeep_user0 [ create_bd_port -dir O -from 10 -to 0 -type data tx_axis_tkeep_user0 ]
  set tx_axis_tkeep_user1 [ create_bd_port -dir O -from 10 -to 0 -type data tx_axis_tkeep_user1 ]
  set tx_axis_tkeep_user2 [ create_bd_port -dir O -from 10 -to 0 -type data tx_axis_tkeep_user2 ]
  set tx_axis_tkeep_user3 [ create_bd_port -dir O -from 10 -to 0 -type data tx_axis_tkeep_user3 ]
  set tx_axis_tlast [ create_bd_port -dir O -type data tx_axis_tlast ]
  set tx_axis_tvalid [ create_bd_port -dir O -type data tx_axis_tvalid ]
  set tx_axis_tready [ create_bd_port -dir I -type data tx_axis_tready ]
  ...
  set_property CONFIG.DIN_FROM {7} $ilslice_4
  ...
  set unused_tkeep [ create_bd_cell -type inline_hdl -vlnv xilinx.com:inline_hdl:ilconstant:1.0 unused_tkeep ]
  set_property -dict [list \
    CONFIG.CONST_VAL {0} \
  ...
  connect_bd_intf_net -intf_net H2C_AXIS_1 [get_bd_intf_ports H2C_AXIS] [get_bd_intf_pins axis_data_fifo_0/S_AXIS]
  ...
  connect_bd_net -net unused_tkeep_dout  [get_bd_pins unused_tkeep/dout] \
  ...
  connect_bd_net -net xdma_axis_aresetn_1  [get_bd_ports xdma_axis_aresetn] \
...
# Proc to create BD mrmac_c2h_stream
proc cr_bd_mrmac_c2h_stream { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name mrmac_c2h_stream
  ...
  # Create interface ports
  set C2H_AXIS [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:axis_rtl:1.0 C2H_AXIS ]
  set_property -dict [ list \
   CONFIG.FREQ_HZ {250000000} \
   ] $C2H_AXIS
  ...
  # Create ports
  set rx_axis_tdata0 [ create_bd_port -dir I -from 63 -to 0 -type data rx_axis_tdata0 ]
  set rx_axis_tdata1 [ create_bd_port -dir I -from 63 -to 0 -type data rx_axis_tdata1 ]
  set rx_axis_tdata2 [ create_bd_port -dir I -from 63 -to 0 -type data rx_axis_tdata2 ]
  set rx_axis_tdata3 [ create_bd_port -dir I -from 63 -to 0 -type data rx_axis_tdata3 ]
  set rx_axis_tkeep_user0 [ create_bd_port -dir I -from 7 -to 0 -type data rx_axis_tkeep_user0 ]
  set rx_axis_tkeep_user1 [ create_bd_port -dir I -from 7 -to 0 -type data rx_axis_tkeep_user1 ]
  set rx_axis_tkeep_user2 [ create_bd_port -dir I -from 7 -to 0 -type data rx_axis_tkeep_user2 ]
  set rx_axis_tkeep_user3 [ create_bd_port -dir I -from 7 -to 0 -type data rx_axis_tkeep_user3 ]
  set rx_axis_tlast [ create_bd_port -dir I -type data rx_axis_tlast ]
  set rx_axis_tvalid [ create_bd_port -dir I -type data rx_axis_tvalid ]
  set mrmac_axis_rx_aclk [ create_bd_port -dir I -type clk -freq_hz 322265500 mrmac_axis_rx_aclk ]
  set xdma_axi_aclk [ create_bd_port -dir I -type clk -freq_hz 250000000 xdma_axi_aclk ]
  set xdma_axis_aresetn [ create_bd_port -dir I -type rst xdma_axis_aresetn ]
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net axis_data_fifo_0_M_AXIS [get_bd_intf_pins axis_data_fifo_1/S_AXIS] [get_bd_intf_pins axis_data_fifo_0/M_AXIS]
  connect_bd_intf_net -intf_net axis_data_fifo_1_M_AXIS [get_bd_intf_ports C2H_AXIS] [get_bd_intf_pins axis_data_fifo_1/M_AXIS]
  ...
  connect_bd_net -net mrmac_axis_rx_aclk_1  [get_bd_ports mrmac_axis_rx_aclk] \
  [get_bd_pins axis_data_fifo_0/s_axis_aclk] \
  [get_bd_pins axis_data_fifo_1/s_axis_aclk] \
  [get_bd_pins proc_sys_reset_0/slowest_sync_clk]
  connect_bd_net -net proc_sys_reset_0_interconnect_aresetn  [get_bd_pins proc_sys_reset_0/interconnect_aresetn] \
  [get_bd_pins axis_data_fifo_0/s_axis_aresetn] \
  [get_bd_pins axis_data_fifo_1/s_axis_aresetn]
  connect_bd_net -net rx_axis_tdata0_1  [get_bd_ports rx_axis_tdata0] \
  [get_bd_pins ilconcat_0/In0]
  connect_bd_net -net rx_axis_tdata1_1  [get_bd_ports rx_axis_tdata1] \
  [get_bd_pins ilconcat_0/In1]
  connect_bd_net -net rx_axis_tdata2_1  [get_bd_ports rx_axis_tdata2] \
  [get_bd_pins ilconcat_0/In2]
  connect_bd_net -net rx_axis_tdata3_1  [get_bd_ports rx_axis_tdata3] \
  [get_bd_pins ilconcat_0/In3]
  connect_bd_net -net rx_axis_tkeep_user0_1  [get_bd_ports rx_axis_tkeep_user0] \
  [get_bd_pins ilslice_0/Din]
  connect_bd_net -net rx_axis_tkeep_user1_1  [get_bd_ports rx_axis_tkeep_user1] \
  [get_bd_pins ilslice_1/Din]
  connect_bd_net -net rx_axis_tkeep_user2_1  [get_bd_ports rx_axis_tkeep_user2] \
  [get_bd_pins ilslice_2/Din]
  connect_bd_net -net rx_axis_tkeep_user3_1  [get_bd_ports rx_axis_tkeep_user3] \
  [get_bd_pins ilslice_3/Din]
  connect_bd_net -net rx_axis_tlast_1  [get_bd_ports rx_axis_tlast] \
  [get_bd_pins axis_data_fifo_0/s_axis_tlast]
  connect_bd_net -net rx_axis_tvalid_1  [get_bd_ports rx_axis_tvalid] \
...
# End of cr_bd_mrmac_c2h_stream()

cr_bd_mrmac_c2h_stream ""
set_property REGISTERED_WITH_MANAGER "1" [get_files mrmac_c2h_stream.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files mrmac_c2h_stream.bd ] 



# Proc to create BD mrmac_40G
proc cr_bd_mrmac_40G { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name mrmac_40G
  ...
  set mrmac_axis_tx_aclk [ create_bd_port -dir O -from 0 -to 0 -type clk mrmac_axis_tx_aclk ]
  set mrmac_axis_rx_aclk [ create_bd_port -dir O -from 0 -to 0 -type clk mrmac_axis_rx_aclk ]
  ...
  set_property -dict [list \
    ...
    CONFIG.MRMAC_PRESET_C0 {1x40GE XLAUI-4 Wide} \
  ] $mrmac_0
  ...
  set_property -dict [list \
    ...
    CONFIG.CHANNEL_ORDERING {/gt_quad_base/TX0_GT_IP_Interface mrmac_40G_mrmac_0_0_0./mrmac_0/gt_tx_serdes_interface_0.0 /gt_quad_base/TX1_GT_IP_Interface mrmac_40G_mrmac_0_0_0./mrmac_0/gt_tx_serdes_interface_1.1\
/gt_quad_base/TX2_GT_IP_Interface mrmac_40G_mrmac_0_0_0./mrmac_0/gt_tx_serdes_interface_2.2 /gt_quad_base/TX3_GT_IP_Interface mrmac_40G_mrmac_0_0_0./mrmac_0/gt_tx_serdes_interface_3.3 /gt_quad_base/RX0_GT_IP_Interface\
mrmac_40G_mrmac_0_0_0./mrmac_0/gt_rx_serdes_interface_0.0 /gt_quad_base/RX1_GT_IP_Interface mrmac_40G_mrmac_0_0_0./mrmac_0/gt_rx_serdes_interface_1.1 /gt_quad_base/RX2_GT_IP_Interface mrmac_40G_mrmac_0_0_0./mrmac_0/gt_rx_serdes_interface_2.2\
/gt_quad_base/RX3_GT_IP_Interface mrmac_40G_mrmac_0_0_0./mrmac_0/gt_rx_serdes_interface_3.3} \
    CONFIG.GT_TYPE {GTYP} \
...
32 TX_INT_DATA_WIDTH 32 TX_BUFFER_MODE 1 TX_BUFFER_BYPASS_MODE Fast_Sync TX_PIPM_ENABLE false TX_OUTCLK_SOURCE TXPROGDIVCLK TXPROGDIV_FREQ_ENABLE true TXPROGDIV_FREQ_SOURCE LCPLL TXPROGDIV_FREQ_VAL 644.531\
...
NRZ RX_HD_EN 0 RX_GRAY_BYP true RX_GRAY_LITTLEENDIAN true RX_PRECODE_BYP true RX_PRECODE_LITTLEENDIAN false INTERNAL_PRESET None XPU_MODE 0 RX_LINE_RATE 10.3125 RX_PLL_TYPE LCPLL RX_REFCLK_FREQUENCY 156.25\
...
RX_BUFFER_RESET_ON_RATE_CHANGE ENABLE RESET_SEQUENCE_INTERVAL 0 RX_COMMA_PRESET NONE RX_COMMA_VALID_ONLY 0 GT_TYPE GTYP} \
    ...
    CONFIG.PROT0_LR1_SETTINGS {GT_DIRECTION DUPLEX TX_PAM_SEL NRZ TX_HD_EN 0 TX_GRAY_BYP true TX_GRAY_LITTLEENDIAN true TX_PRECODE_BYP true TX_PRECODE_LITTLEENDIAN false TX_LINE_RATE 10.3125 TX_PLL_TYPE\
LCPLL TX_REFCLK_FREQUENCY 156.25 TX_ACTUAL_REFCLK_FREQUENCY 156.250000000000 TX_FRACN_ENABLED false TX_FRACN_OVRD false TX_FRACN_NUMERATOR 0 TX_REFCLK_SOURCE R0 TX_DATA_ENCODING RAW TX_USER_DATA_WIDTH\
32 TX_INT_DATA_WIDTH 32 TX_BUFFER_MODE 1 TX_BUFFER_BYPASS_MODE Fast_Sync TX_PIPM_ENABLE false TX_OUTCLK_SOURCE TXPROGDIVCLK TXPROGDIV_FREQ_ENABLE true TXPROGDIV_FREQ_SOURCE LCPLL TXPROGDIV_FREQ_VAL 644.531\
TX_DIFF_SWING_EMPH_MODE CUSTOM TX_64B66B_SCRAMBLER false TX_64B66B_ENCODER false TX_64B66B_CRC false TX_RATE_GROUP A TX_LANE_DESKEW_HDMI_ENABLE false TX_BUFFER_RESET_ON_RATE_CHANGE ENABLE PRESET None RX_PAM_SEL\
NRZ RX_HD_EN 0 RX_GRAY_BYP true RX_GRAY_LITTLEENDIAN true RX_PRECODE_BYP true RX_PRECODE_LITTLEENDIAN false INTERNAL_PRESET None XPU_MODE 0 RX_LINE_RATE 10.3125 RX_PLL_TYPE LCPLL RX_REFCLK_FREQUENCY 156.25\
...
250 PCIE_USERCLK_FREQ 250 RX_JTOL_FC 6.1862627 RX_JTOL_LF_SLOPE -20 RX_BUFFER_BYPASS_MODE Fast_Sync RX_BUFFER_BYPASS_MODE_LANE MULTI RX_BUFFER_RESET_ON_CB_CHANGE ENABLE RX_BUFFER_RESET_ON_COMMAALIGN DISABLE\
RX_BUFFER_RESET_ON_RATE_CHANGE ENABLE RESET_SEQUENCE_INTERVAL 0 RX_COMMA_PRESET NONE RX_COMMA_VALID_ONLY 0 GT_TYPE GTYP} \
    CONFIG.PROT0_LR2_SETTINGS {GT_DIRECTION DUPLEX TX_PAM_SEL NRZ TX_HD_EN 0 TX_GRAY_BYP true TX_GRAY_LITTLEENDIAN true TX_PRECODE_BYP true TX_PRECODE_LITTLEENDIAN false TX_LINE_RATE 10.3125 TX_PLL_TYPE\
LCPLL TX_REFCLK_FREQUENCY 156.25 TX_ACTUAL_REFCLK_FREQUENCY 156.250000000000 TX_FRACN_ENABLED false TX_FRACN_OVRD false TX_FRACN_NUMERATOR 0 TX_REFCLK_SOURCE R0 TX_DATA_ENCODING RAW TX_USER_DATA_WIDTH\
32 TX_INT_DATA_WIDTH 32 TX_BUFFER_MODE 1 TX_BUFFER_BYPASS_MODE Fast_Sync TX_PIPM_ENABLE false TX_OUTCLK_SOURCE TXPROGDIVCLK TXPROGDIV_FREQ_ENABLE true TXPROGDIV_FREQ_SOURCE LCPLL TXPROGDIV_FREQ_VAL 644.531\
TX_DIFF_SWING_EMPH_MODE CUSTOM TX_64B66B_SCRAMBLER false TX_64B66B_ENCODER false TX_64B66B_CRC false TX_RATE_GROUP A TX_LANE_DESKEW_HDMI_ENABLE false TX_BUFFER_RESET_ON_RATE_CHANGE ENABLE PRESET None RX_PAM_SEL\
NRZ RX_HD_EN 0 RX_GRAY_BYP true RX_GRAY_LITTLEENDIAN true RX_PRECODE_BYP true RX_PRECODE_LITTLEENDIAN false INTERNAL_PRESET None XPU_MODE 0 RX_LINE_RATE 10.3125 RX_PLL_TYPE LCPLL RX_REFCLK_FREQUENCY 156.25\
...
RX_BUFFER_RESET_ON_RATE_CHANGE ENABLE RESET_SEQUENCE_INTERVAL 0 RX_COMMA_PRESET NONE RX_COMMA_VALID_ONLY 0 GT_TYPE GTYP} \
    ...
    CONFIG.QUAD_USAGE {TX_QUAD_CH {TXQuad_0_/gt_quad_base {/gt_quad_base mrmac_40G_mrmac_0_0_0.IP_CH0,mrmac_40G_mrmac_0_0_0.IP_CH1,mrmac_40G_mrmac_0_0_0.IP_CH2,mrmac_40G_mrmac_0_0_0.IP_CH3 MSTRCLK 1,0,0,0\
IS_CURRENT_QUAD 1}} RX_QUAD_CH {RXQuad_0_/gt_quad_base {/gt_quad_base mrmac_40G_mrmac_0_0_0.IP_CH0,mrmac_40G_mrmac_0_0_0.IP_CH1,mrmac_40G_mrmac_0_0_0.IP_CH2,mrmac_40G_mrmac_0_0_0.IP_CH3 MSTRCLK 1,0,0,0\
IS_CURRENT_QUAD 1}}} \
  ...
  connect_bd_intf_net -intf_net mrmac_0_gt_rx_serdes_interface_2 [get_bd_intf_pins mrmac_0/gt_rx_serdes_interface_2] [get_bd_intf_pins gt_quad_base/RX2_GT_IP_Interface]
  connect_bd_intf_net -intf_net mrmac_0_gt_rx_serdes_interface_3 [get_bd_intf_pins mrmac_0/gt_rx_serdes_interface_3] [get_bd_intf_pins gt_quad_base/RX3_GT_IP_Interface]
  ...
  connect_bd_intf_net -intf_net mrmac_0_gt_tx_serdes_interface_2 [get_bd_intf_pins mrmac_0/gt_tx_serdes_interface_2] [get_bd_intf_pins gt_quad_base/TX2_GT_IP_Interface]
  connect_bd_intf_net -intf_net mrmac_0_gt_tx_serdes_interface_3 [get_bd_intf_pins mrmac_0/gt_tx_serdes_interface_3] [get_bd_intf_pins gt_quad_base/TX3_GT_IP_Interface]
  ...
  connect_bd_net -net gt_quad_base_ch3_txoutclk  [get_bd_pins gt_quad_base/ch3_txoutclk] \
  [get_bd_pins mbufg_gt_0_3/MBUFG_GT_I]
  ...
  connect_bd_net -net mbufg_gt_0_3_MBUFG_GT_O2  [get_bd_pins mbufg_gt_0_3/MBUFG_GT_O2] \
  ...
  [get_bd_ports mrmac_axis_tx_aclk]
  ...
  [get_bd_ports mrmac_axis_rx_aclk]
  ...
  connect_bd_net -net mrmac_0_tx_clr_out_2  [get_bd_pins mrmac_0/tx_clr_out_2] \
  [get_bd_pins mbufg_gt_0_2/MBUFG_GT_CLR]
  connect_bd_net -net mrmac_0_tx_clr_out_3  [get_bd_pins mrmac_0/tx_clr_out_3] \
  [get_bd_pins mbufg_gt_0_3/MBUFG_GT_CLR]
  ...
  connect_bd_net -net mrmac_0_tx_clrb_leaf_out_2  [get_bd_pins mrmac_0/tx_clrb_leaf_out_2] \
  [get_bd_pins mbufg_gt_0_2/MBUFG_GT_CLRB_LEAF]
  connect_bd_net -net mrmac_0_tx_clrb_leaf_out_3  [get_bd_pins mrmac_0/tx_clrb_leaf_out_3] \
  [get_bd_pins mbufg_gt_0_3/MBUFG_GT_CLRB_LEAF]
  ...
  [get_bd_pins mbufg_gt_0_3/MBUFG_GT_CE]
...
# End of cr_bd_mrmac_40G()

cr_bd_mrmac_40G ""
set_property REGISTERED_WITH_MANAGER "1" [get_files mrmac_40G.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files mrmac_40G.bd ] 



# Proc to create BD VD100_40G_ether
proc cr_bd_VD100_40G_ether { parentCell } {
# The design that will be created by this Tcl proc contains the following 
# block design container source references:
# mrmac_40G, mrmac_h2c_stream, mrmac_c2h_stream



  # CHANGE DESIGN NAME HERE
  set design_name VD100_40G_ether
  ...
  ##################################################################
  set bCheckSources 1
  set list_bdc_active "mrmac_40G, mrmac_h2c_stream, mrmac_c2h_stream"
...
32 RX_REFCLK_FREQUENCY 100} \
    CONFIG.INTF0_PARENTID {VD100_40G_ether_pcie_phy_0} \
...
refclk_PROT0_R0_100_MHz_unique1} \
  ...
  # Create instance: mrmac_40G_0, and set properties
  set mrmac_40G_0 [ create_bd_cell -type container -reference mrmac_40G mrmac_40G_0 ]
  set_property -dict [list \
    CONFIG.ACTIVE_SIM_BD {mrmac_40G.bd} \
    CONFIG.ACTIVE_SYNTH_BD {mrmac_40G.bd} \
    CONFIG.ENABLE_DFX {0} \
    CONFIG.LIST_SIM_BD {mrmac_40G.bd} \
    CONFIG.LIST_SYNTH_BD {mrmac_40G.bd} \
    CONFIG.LOCK_PROPAGATE {0} \
  ] $mrmac_40G_0


  set_property SELECTED_SIM_MODEL rtl  $mrmac_40G_0
  ...
  # Create instance: mrmac_c2h_stream_0, and set properties
  set mrmac_c2h_stream_0 [ create_bd_cell -type container -reference mrmac_c2h_stream mrmac_c2h_stream_0 ]
  set_property -dict [list \
    CONFIG.ACTIVE_SIM_BD {mrmac_c2h_stream.bd} \
    CONFIG.ACTIVE_SYNTH_BD {mrmac_c2h_stream.bd} \
    CONFIG.ENABLE_DFX {0} \
    CONFIG.LIST_SIM_BD {mrmac_c2h_stream.bd} \
    CONFIG.LIST_SYNTH_BD {mrmac_c2h_stream.bd} \
    CONFIG.LOCK_PROPAGATE {0} \
  ] $mrmac_c2h_stream_0


  set_property SELECTED_SIM_MODEL rtl  $mrmac_c2h_stream_0

  # Create interface connections
  connect_bd_intf_net -intf_net SFP_REF_1 [get_bd_intf_pins mrmac_40G_0/SFP_REF] [get_bd_intf_ports SFP_REF]
  ...
  connect_bd_intf_net -intf_net axi_smc_M02_AXI [get_bd_intf_pins axi_smc/M02_AXI] [get_bd_intf_pins mrmac_40G_0/s_axi]
  connect_bd_intf_net -intf_net mrmac_40G_0_GT_Serial [get_bd_intf_ports SFP_serial] [get_bd_intf_pins mrmac_40G_0/SFP_serial]
  connect_bd_intf_net -intf_net mrmac_c2h_stream_0_C2H_AXIS [get_bd_intf_pins mrmac_c2h_stream_0/C2H_AXIS] [get_bd_intf_pins xdma_0/S_AXIS_C2H_0]
  ...
  [get_bd_pins ilslice_0/Din] \
  [get_bd_pins ilslice_1/Din]
  connect_bd_net -net gtwiz_freerun_clk_1  [get_bd_pins versal_cips_0/pl0_ref_clk] \
  [get_bd_pins xdma_0_support/gtwiz_freerun_clk] \
  [get_bd_pins mrmac_40G_0/apb3clk_quad]
  connect_bd_net -net ilslice_0_Dout  [get_bd_pins ilslice_0/Dout] \
  [get_bd_ports SFP1_TX_EN]
  connect_bd_net -net ilslice_1_Dout  [get_bd_pins ilslice_1/Dout] \
  [get_bd_ports SFP2_TX_EN]
  connect_bd_net -net mrmac_axis_rx_aclk_1  [get_bd_pins mrmac_40G_0/mrmac_axis_rx_aclk] \
  [get_bd_pins mrmac_c2h_stream_0/mrmac_axis_rx_aclk]
  connect_bd_net -net mrmac_axis_tx_aclk_1  [get_bd_pins mrmac_40G_0/mrmac_axis_tx_aclk] \
  [get_bd_pins mrmac_h2c_stream_0/mrmac_axis_tx_aclk]
  connect_bd_net -net mrmac_h2c_stream_0_tx_axis_tdata0  [get_bd_pins mrmac_h2c_stream_0/tx_axis_tdata0] \
  [get_bd_pins mrmac_40G_0/tx_axis_tdata0]
  connect_bd_net -net mrmac_h2c_stream_0_tx_axis_tdata1  [get_bd_pins mrmac_h2c_stream_0/tx_axis_tdata1] \
  [get_bd_pins mrmac_40G_0/tx_axis_tdata1]
  connect_bd_net -net mrmac_h2c_stream_0_tx_axis_tdata2  [get_bd_pins mrmac_h2c_stream_0/tx_axis_tdata2] \
  [get_bd_pins mrmac_40G_0/tx_axis_tdata2]
  connect_bd_net -net mrmac_h2c_stream_0_tx_axis_tdata3  [get_bd_pins mrmac_h2c_stream_0/tx_axis_tdata3] \
  [get_bd_pins mrmac_40G_0/tx_axis_tdata3]
  connect_bd_net -net mrmac_h2c_stream_0_tx_axis_tkeep_user0  [get_bd_pins mrmac_h2c_stream_0/tx_axis_tkeep_user0] \
  [get_bd_pins mrmac_40G_0/tx_axis_tkeep_user0]
  connect_bd_net -net mrmac_h2c_stream_0_tx_axis_tkeep_user1  [get_bd_pins mrmac_h2c_stream_0/tx_axis_tkeep_user1] \
  [get_bd_pins mrmac_40G_0/tx_axis_tkeep_user1]
  connect_bd_net -net mrmac_h2c_stream_0_tx_axis_tkeep_user2  [get_bd_pins mrmac_h2c_stream_0/tx_axis_tkeep_user2] \
  [get_bd_pins mrmac_40G_0/tx_axis_tkeep_user2]
  connect_bd_net -net mrmac_h2c_stream_0_tx_axis_tlast  [get_bd_pins mrmac_h2c_stream_0/tx_axis_tlast] \
  [get_bd_pins mrmac_40G_0/tx_axis_tlast_0]
  connect_bd_net -net mrmac_h2c_stream_0_tx_axis_tvalid  [get_bd_pins mrmac_h2c_stream_0/tx_axis_tvalid] \
  [get_bd_pins mrmac_40G_0/tx_axis_tvalid_0]
  connect_bd_net -net rx_axis_tdata0_1  [get_bd_pins mrmac_40G_0/rx_axis_tdata0] \
  [get_bd_pins mrmac_c2h_stream_0/rx_axis_tdata0]
  connect_bd_net -net rx_axis_tdata1_1  [get_bd_pins mrmac_40G_0/rx_axis_tdata1] \
  [get_bd_pins mrmac_c2h_stream_0/rx_axis_tdata1]
  connect_bd_net -net rx_axis_tdata2_1  [get_bd_pins mrmac_40G_0/rx_axis_tdata2] \
  [get_bd_pins mrmac_c2h_stream_0/rx_axis_tdata2]
  connect_bd_net -net rx_axis_tdata3_1  [get_bd_pins mrmac_40G_0/rx_axis_tdata3] \
  [get_bd_pins mrmac_c2h_stream_0/rx_axis_tdata3]
  connect_bd_net -net rx_axis_tkeep_user0_1  [get_bd_pins mrmac_40G_0/rx_axis_tkeep_user0] \
  [get_bd_pins mrmac_c2h_stream_0/rx_axis_tkeep_user0]
  connect_bd_net -net rx_axis_tkeep_user1_1  [get_bd_pins mrmac_40G_0/rx_axis_tkeep_user1] \
  [get_bd_pins mrmac_c2h_stream_0/rx_axis_tkeep_user1]
  connect_bd_net -net rx_axis_tkeep_user2_1  [get_bd_pins mrmac_40G_0/rx_axis_tkeep_user2] \
  [get_bd_pins mrmac_c2h_stream_0/rx_axis_tkeep_user2]
  connect_bd_net -net rx_axis_tkeep_user3_1  [get_bd_pins mrmac_40G_0/rx_axis_tkeep_user3] \
  [get_bd_pins mrmac_c2h_stream_0/rx_axis_tkeep_user3]
  connect_bd_net -net rx_axis_tlast_1  [get_bd_pins mrmac_40G_0/rx_axis_tlast_0] \
  [get_bd_pins mrmac_c2h_stream_0/rx_axis_tlast]
  connect_bd_net -net rx_axis_tvalid_1  [get_bd_pins mrmac_40G_0/rx_axis_tvalid_0] \
  [get_bd_pins mrmac_c2h_stream_0/rx_axis_tvalid]
  connect_bd_net -net sys_reset_1  [get_bd_ports PCIE_PERST] \
  [get_bd_pins xdma_0_support/sys_reset]
  connect_bd_net -net tx_axis_tkeep_user3_1  [get_bd_pins mrmac_h2c_stream_0/tx_axis_tkeep_user3] \
  [get_bd_pins mrmac_40G_0/tx_axis_tkeep_user3]
  connect_bd_net -net tx_axis_tready_1  [get_bd_pins mrmac_40G_0/tx_axis_tready_0] \
  [get_bd_pins mrmac_h2c_stream_0/tx_axis_tready]
  connect_bd_net -net xdma_0_axi_aclk  [get_bd_pins xdma_0/axi_aclk] \
  [get_bd_pins mrmac_40G_0/s_axi_aclk] \
  [get_bd_pins axi_smc/aclk] \
  [get_bd_pins axi_gpio_0/s_axi_aclk] \
  [get_bd_pins axi_iic_0/s_axi_aclk] \
  [get_bd_pins mrmac_h2c_stream_0/xdma_axi_aclk] \
  [get_bd_pins mrmac_c2h_stream_0/xdma_axi_aclk]
  connect_bd_net -net xdma_0_axi_aresetn  [get_bd_pins xdma_0/axi_aresetn] \
  [get_bd_pins mrmac_40G_0/s_axi_aresetn] \
  [get_bd_pins axi_gpio_0/s_axi_aresetn] \
  [get_bd_pins axi_smc/aresetn] \
  [get_bd_pins axi_iic_0/s_axi_aresetn] \
  [get_bd_pins mrmac_40G_0/mrmac_resetn] \
  [get_bd_pins mrmac_h2c_stream_0/xdma_axis_aresetn] \
  [get_bd_pins mrmac_c2h_stream_0/xdma_axis_aresetn]
  ...
  assign_bd_address -offset 0x00000000 -range 0x00010000 -target_address_space [get_bd_addr_spaces xdma_0/M_AXI_LITE] [get_bd_addr_segs mrmac_40G_0/mrmac_0/s_axi/Reg] -force
...
# End of cr_bd_VD100_40G_ether()

cr_bd_VD100_40G_ether ""
set_property REGISTERED_WITH_MANAGER "1" [get_files VD100_40G_ether.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files VD100_40G_ether.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list VD100_40G_ether.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/VD100_40G_ether/VD100_40G_ether.gen/sources_1/bd/VD100_40G_ether/hdl/VD100_40G_ether_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list VD100_40G_ether.bd]] -top]
  add_files -norecurse -fileset sources_1 $wrapper_path
}


generate_target all [get_files VD100_40G_ether.bd]

create_ip_run [get_files VD100_40G_ether.bd]

# Set 'mrmac_40G_inst_0' fileset object
set obj [get_filesets mrmac_40G_inst_0]
# Set 'mrmac_40G_inst_0' fileset file properties for remote files
# None

# Set 'mrmac_40G_inst_0' fileset file properties for local files
# None

# Set 'mrmac_40G_inst_0' fileset properties
set obj [get_filesets mrmac_40G_inst_0]
set_property -name "top" -value "mrmac_40G_inst_0" -objects $obj
...
# Set 'mrmac_c2h_stream_inst_0' fileset object
set obj [get_filesets mrmac_c2h_stream_inst_0]
# Set 'mrmac_c2h_stream_inst_0' fileset file properties for remote files
# None

# Set 'mrmac_c2h_stream_inst_0' fileset file properties for local files
# None

# Set 'mrmac_c2h_stream_inst_0' fileset properties
set obj [get_filesets mrmac_c2h_stream_inst_0]
set_property -name "top" -value "mrmac_c2h_stream_inst_0" -objects $obj
set_property -name "top_auto_set" -value "0" -objects $obj
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xcve2302-sfva784-1LP-e-S -flow {Vivado Advanced Implementation 2025} -strategy "Performance_AggressiveExplore" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
...
set obj [get_runs impl_1]
set_property -name "part" -value "xcve2302-sfva784-1LP-e-S" -objects $obj
set_property -name "strategy" -value "Performance_AggressiveExplore" -objects $obj
set_property -name "steps.opt_design.args.directive" -value "Explore" -objects $obj
set_property -name "steps.place_design.args.directive" -value "AggressiveExplore" -objects $obj
