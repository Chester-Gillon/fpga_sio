...
#
# create_project.tcl: Tcl script for re-creating project 'AS02MC04_enum'
#
# Generated by Vivado on Sun May 10 14:37:50 BST 2026
...
#    "/home/mr_halfword/fpga_sio/fpga_tests/AS02MC04_enum/gen3_x8_reversed_lane_order_pipe_debug/pcie.xdc"
#    "/home/mr_halfword/fpga_sio/AS02MC04/constraints/qaudspi.xdc"
#    "/home/mr_halfword/fpga_sio/fpga_tests/AS02MC04_enum/gen3_x8_reversed_lane_order_pipe_debug/pcie_pipe_debug.xdc"
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/pcie_pipe_debug.xdc"]"\
...
set _xil_proj_name_ "AS02MC04_enum"
...
set orig_proj_dir "[file normalize "$origin_dir/AS02MC04_enum"]"
...
set_property -name "top" -value "AS02MC04_enum_wrapper" -objects $obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/pcie_pipe_debug.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/pcie_pipe_debug.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
...
set obj [get_filesets constrs_1]
set_property -name "target_constrs_file" -value "[file normalize "$origin_dir/pcie_pipe_debug.xdc"]" -objects $obj
set_property -name "target_part" -value "xcku3p-ffvb676-1-e" -objects $obj
set_property -name "target_ucf" -value "[file normalize "$origin_dir/pcie_pipe_debug.xdc"]" -objects $obj
...
# Proc to create BD AS02MC04_enum
proc cr_bd_AS02MC04_enum { parentCell } {
...
# usr_accesse2_read
  ...
  assign_bd_address -offset 0x00000000 -range 0x00001000 -target_address_space [get_bd_addr_spaces xdma_0/M_AXI_LITE] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] -force
...
# End of cr_bd_AS02MC04_enum()

cr_bd_AS02MC04_enum ""
set_property REGISTERED_WITH_MANAGER "1" [get_files AS02MC04_enum.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files AS02MC04_enum.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list AS02MC04_enum.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/AS02MC04_enum/AS02MC04_enum.gen/sources_1/bd/AS02MC04_enum/hdl/AS02MC04_enum_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list AS02MC04_enum.bd]] -top]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xcku3p-ffvb676-1-e -flow {Vivado Synthesis 2025} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xcku3p-ffvb676-1-e -flow {Vivado Implementation 2025} -strategy "Performance_Explore" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
