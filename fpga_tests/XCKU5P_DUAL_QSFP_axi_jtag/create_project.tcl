...
#
# create_project.tcl: Tcl script for re-creating project 'XCKU5P_DUAL_QSFP_axi_jtag'
#
# Generated by Vivado on Thu Dec 19 20:54:20 GMT 2024
...
set _xil_proj_name_ "XCKU5P_DUAL_QSFP_axi_jtag"
...
set orig_proj_dir "[file normalize "$origin_dir/XCKU5P_DUAL_QSFP_axi_jtag"]"
...
set_property -name "top" -value "XCKU5P_DUAL_QSFP_axi_jtag_wrapper" -objects $obj
...
# Proc to create BD XCKU5P_DUAL_QSFP_axi_jtag
proc cr_bd_XCKU5P_DUAL_QSFP_axi_jtag { parentCell } {
...
# usr_accesse2_read
  ...
  set design_name XCKU5P_DUAL_QSFP_axi_jtag
...
# End of cr_bd_XCKU5P_DUAL_QSFP_axi_jtag()

cr_bd_XCKU5P_DUAL_QSFP_axi_jtag ""
set_property REGISTERED_WITH_MANAGER "1" [get_files XCKU5P_DUAL_QSFP_axi_jtag.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files XCKU5P_DUAL_QSFP_axi_jtag.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list XCKU5P_DUAL_QSFP_axi_jtag.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/XCKU5P_DUAL_QSFP_axi_jtag/XCKU5P_DUAL_QSFP_axi_jtag.gen/sources_1/bd/XCKU5P_DUAL_QSFP_axi_jtag/hdl/XCKU5P_DUAL_QSFP_axi_jtag_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list XCKU5P_DUAL_QSFP_axi_jtag.bd]] -top]
