...
#
# create_project.tcl: Tcl script for re-creating project 'VD100_enum'
#
# Generated by Vivado on Sun Jun 07 21:44:36 BST 2026
...
#
#    "/home/mr_halfword/fpga_sio/fpga_tests/VD100_enum/gen2_x4_sfp_ref_clk/pcie.xdc"
#    "/home/mr_halfword/fpga_sio/multiple_boards/copy_device_image_and_debug_probes.tcl"
#
#*****************************************************************************************
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../gen2_x4_sfp_ref_clk/pcie.xdc"]"\
 "[file normalize "$origin_dir/../../../multiple_boards/copy_device_image_and_debug_probes.tcl"]"\
  ]
  foreach ifile $files {
...
set _xil_proj_name_ "VD100_enum"
...
set orig_proj_dir "[file normalize "$origin_dir/VD100_enum"]"
...
set_property -name "top" -value "VD100_enum_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../gen2_x4_sfp_ref_clk/pcie.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../gen2_x4_sfp_ref_clk/pcie.xdc"
...
set file "$origin_dir/../../../multiple_boards/copy_device_image_and_debug_probes.tcl"
set file [file normalize $file]
...
# Proc to create BD VD100_enum
proc cr_bd_VD100_enum { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name VD100_enum
...
proc create_hier_cell_xdma_0_support { parentCell nameHier } {
  ...
  create_bd_intf_pin -mode Master -vlnv xilinx.com:interface:gt_rtl:1.0 pcie_mgt_1
  ...
  set_property -dict [list \
    ...
    CONFIG.INTF0_GT_SETTINGS(LR0_SETTINGS) {TX_BUFFER_MODE 0 PCIE_ENABLE true TX_PLL_TYPE LCPLL TX_REFCLK_SOURCE R0 TXPROGDIV_FREQ_ENABLE true TX_OUTCLK_SOURCE TXPROGDIVCLK TX_DIFF_SWING_EMPH_MODE CUSTOM\
TX_BUFFER_BYPASS_MODE Fast_Sync TX_DATA_ENCODING 8B10B TX_LINE_RATE 2.5 TX_USER_DATA_WIDTH 16 TX_INT_DATA_WIDTH 20 TX_REFCLK_FREQUENCY 156.25 PCIE_USERCLK_FREQ 250 PCIE_USERCLK2_FREQ 250 OOB_ENABLE true\
RX_BUFFER_MODE 1 RXPROGDIV_FREQ_ENABLE false RX_CC_LEN_SEQ 1 RX_CC_NUM_SEQ 1 RX_CC_K_0_0 true RX_CC_MASK_0_0 false RX_CC_VAL_0_0 00011100 RX_CC_KEEP_IDLE ENABLE RX_COMMA_ALIGN_WORD 1 RX_COMMA_PRESET K28.5\
RX_COMMA_M_ENABLE true RX_COMMA_P_ENABLE true RX_COMMA_MASK 1111111111 RX_COMMA_M_VAL 0101111100 RX_COMMA_P_VAL 1010000011 RX_COMMA_DOUBLE_ENABLE false RX_JTOL_FC 1 RX_PLL_TYPE LCPLL RX_SLIDE_MODE OFF\
RX_REFCLK_SOURCE R0 RX_OUTCLK_SOURCE RXOUTCLKPMA RX_EQ_MODE LPM RX_SSC_PPM 0 INS_LOSS_NYQ 20 RX_DATA_DECODING 8B10B RX_LINE_RATE 2.5 RX_PPM_OFFSET 0 RX_USER_DATA_WIDTH 16 RX_INT_DATA_WIDTH 20 RX_REFCLK_FREQUENCY\
156.25} \
    CONFIG.INTF0_GT_SETTINGS(LR1_SETTINGS) {TX_BUFFER_MODE 0 PCIE_ENABLE true TX_PLL_TYPE LCPLL TX_REFCLK_SOURCE R0 TXPROGDIV_FREQ_ENABLE true TX_OUTCLK_SOURCE TXPROGDIVCLK TX_DIFF_SWING_EMPH_MODE CUSTOM\
TX_BUFFER_BYPASS_MODE Fast_Sync TX_DATA_ENCODING 8B10B TX_LINE_RATE 5.0 TX_USER_DATA_WIDTH 16 TX_INT_DATA_WIDTH 20 TX_REFCLK_FREQUENCY 156.25 PCIE_USERCLK_FREQ 250 PCIE_USERCLK2_FREQ 250 OOB_ENABLE true\
RX_BUFFER_MODE 1 RXPROGDIV_FREQ_ENABLE false RX_CC_LEN_SEQ 1 RX_CC_NUM_SEQ 1 RX_CC_K_0_0 true RX_CC_MASK_0_0 false RX_CC_VAL_0_0 00011100 RX_CC_KEEP_IDLE ENABLE RX_COMMA_ALIGN_WORD 1 RX_COMMA_PRESET K28.5\
RX_COMMA_M_ENABLE true RX_COMMA_P_ENABLE true RX_COMMA_MASK 1111111111 RX_COMMA_M_VAL 0101111100 RX_COMMA_P_VAL 1010000011 RX_COMMA_DOUBLE_ENABLE false RX_JTOL_FC 1 RX_PLL_TYPE LCPLL RX_SLIDE_MODE OFF\
RX_REFCLK_SOURCE R0 RX_OUTCLK_SOURCE RXOUTCLKPMA RX_EQ_MODE LPM RX_SSC_PPM 0 INS_LOSS_NYQ 20 RX_DATA_DECODING 8B10B RX_LINE_RATE 5.0 RX_PPM_OFFSET 0 RX_USER_DATA_WIDTH 16 RX_INT_DATA_WIDTH 20 RX_REFCLK_FREQUENCY\
156.25} \
    CONFIG.INTF0_GT_SETTINGS(LR2_SETTINGS) {TX_BUFFER_MODE 0 PCIE_ENABLE true TX_PLL_TYPE LCPLL TX_REFCLK_SOURCE R0 TXPROGDIV_FREQ_ENABLE true TX_OUTCLK_SOURCE TXPROGDIVCLK TX_DIFF_SWING_EMPH_MODE CUSTOM\
TX_BUFFER_BYPASS_MODE Fast_Sync TX_DATA_ENCODING 128B130B TX_LINE_RATE 8.0 TX_USER_DATA_WIDTH 32 TX_INT_DATA_WIDTH 32 TX_REFCLK_FREQUENCY 156.25 PCIE_USERCLK_FREQ 250 PCIE_USERCLK2_FREQ 250 OOB_ENABLE\
true RX_BUFFER_MODE 1 RXPROGDIV_FREQ_ENABLE false RX_CC_LEN_SEQ 1 RX_CC_NUM_SEQ 1 RX_CC_K_0_0 true RX_CC_MASK_0_0 false RX_CC_VAL_0_0 00011100 RX_CC_KEEP_IDLE ENABLE RX_COMMA_ALIGN_WORD 1 RX_COMMA_PRESET\
K28.5 RX_COMMA_M_ENABLE true RX_COMMA_P_ENABLE true RX_COMMA_MASK 1111111111 RX_COMMA_DOUBLE_ENABLE false RX_JTOL_FC 1 RX_PLL_TYPE LCPLL RX_SLIDE_MODE OFF RX_REFCLK_SOURCE R0 RX_OUTCLK_SOURCE RXOUTCLKPMA\
RX_EQ_MODE DFE RX_SSC_PPM 0 INS_LOSS_NYQ 20 RX_DATA_DECODING 128B130B RX_LINE_RATE 8.0 RX_PPM_OFFSET 0 RX_USER_DATA_WIDTH 32 RX_INT_DATA_WIDTH 32 RX_REFCLK_FREQUENCY 156.25} \
    CONFIG.INTF0_GT_SETTINGS(LR3_SETTINGS) {TX_BUFFER_MODE 0 PCIE_ENABLE true TX_PLL_TYPE LCPLL TX_REFCLK_SOURCE R0 TXPROGDIV_FREQ_ENABLE true TX_OUTCLK_SOURCE TXPROGDIVCLK TX_DIFF_SWING_EMPH_MODE CUSTOM\
TX_BUFFER_BYPASS_MODE Fast_Sync TX_DATA_ENCODING 128B130B TX_LINE_RATE 16.0 TX_USER_DATA_WIDTH 32 TX_INT_DATA_WIDTH 32 TX_REFCLK_FREQUENCY 156.25 PCIE_USERCLK_FREQ 250 TXPROGDIV_FREQ_VAL 500.000 PCIE_USERCLK2_FREQ\
...
32 RX_REFCLK_FREQUENCY 156.25} \
    CONFIG.INTF0_PARENTID {VD100_enum_pcie_phy_0} \
...
QUAD0_TX0 /xdma_0_support/pcie_phy/GT_TX0 QUAD0_TX1 /xdma_0_support/pcie_phy/GT_TX1 QUAD0_TX2 /xdma_0_support/pcie_phy/GT_TX2 QUAD0_TX3 /xdma_0_support/pcie_phy/GT_TX3} \
    CONFIG.QUAD0_REFCLK_STRING {HSCLK0_LCPLLGTREFCLK0 refclk_PROT0_R0_multiple_ext_freq HSCLK1_LCPLLGTREFCLK0 refclk_PROT0_R0_multiple_ext_freq} \
  ] $gtwiz_versal_0
  ...
  set_property CONFIG.C_BUF_TYPE {BUFGCE} $util_ds_buf_0


  # Create interface connections
  connect_bd_intf_net -intf_net Conn1 [get_bd_intf_pins pcie_phy/pcie_mgt] [get_bd_intf_pins pcie_mgt_1]
  connect_bd_intf_net -intf_net Conn2 [get_bd_intf_pins refclk_ibuf/CLK_IN_D] [get_bd_intf_pins pcie_refclk_1]
  ...
  connect_bd_intf_net -intf_net Conn10 [get_bd_intf_pins pcie/pcie_cfg_status] [get_bd_intf_pins pcie_cfg_status]
  connect_bd_intf_net -intf_net Conn11 [get_bd_intf_pins pcie/pcie_transmit_fc] [get_bd_intf_pins pcie_transmit_fc]
  connect_bd_intf_net -intf_net Conn12 [get_bd_intf_pins pcie/s_axis_cc] [get_bd_intf_pins s_axis_cc]
  connect_bd_intf_net -intf_net Conn13 [get_bd_intf_pins pcie/s_axis_rq] [get_bd_intf_pins s_axis_rq]
  ...
  connect_bd_net -net util_ds_buf_0_BUFGCE_O  [get_bd_pins util_ds_buf_0/BUFGCE_O] \
  ...
  # Create interface connections
  connect_bd_intf_net -intf_net pcie_refclk_2 [get_bd_intf_ports pcie_refclk] [get_bd_intf_pins xdma_0_support/pcie_refclk_1]
  ...
  connect_bd_intf_net -intf_net xdma_0_support_pcie_mgt_1 [get_bd_intf_ports pcie_mgt] [get_bd_intf_pins xdma_0_support/pcie_mgt_1]
...
# End of cr_bd_VD100_enum()

cr_bd_VD100_enum ""
set_property REGISTERED_WITH_MANAGER "1" [get_files VD100_enum.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files VD100_enum.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list VD100_enum.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/VD100_enum/VD100_enum.gen/sources_1/bd/VD100_enum/hdl/VD100_enum_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list VD100_enum.bd]] -top]
...
set_property -name "steps.write_device_image.tcl.post" -value "[file normalize "$origin_dir/../../../multiple_boards/copy_device_image_and_debug_probes.tcl"]" -objects $obj
