...
#
# Generated by Vivado on Sun Dec 01 10:43:55 GMT 2024
...
# usr_accesse2_read
  ...
  # Create instance: h2c_tready, and set properties
  set h2c_tready [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 h2c_tready ]

  # Create instance: c2h_tvalid, and set properties
  set c2h_tvalid [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 c2h_tvalid ]

  # Create instance: c2h_tlast, and set properties
  set c2h_tlast [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 c2h_tlast ]
  set_property CONFIG.CONST_VAL {0} $c2h_tlast


  # Create instance: c2h_tkeep, and set properties
  set c2h_tkeep [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 c2h_tkeep ]
  set_property -dict [list \
  ...
  # Create instance: c2h_tdata, and set properties
  set c2h_tdata [ create_bd_cell -type ip -vlnv xilinx.com:ip:xlconstant:1.1 c2h_tdata ]
  set_property -dict [list \
    CONFIG.CONST_VAL {0xfeedabbadeadbeeffeedacdcdeadbeeffeedabbadeadbeeffeedacdcdeadbeef} \
  ...
  connect_bd_net -net c2h_tdata_dout  [get_bd_pins c2h_tdata/dout] \
  [get_bd_pins xdma_0/s_axis_c2h_tdata_3] \
  [get_bd_pins xdma_0/s_axis_c2h_tdata_2] \
  [get_bd_pins xdma_0/s_axis_c2h_tdata_1] \
  [get_bd_pins xdma_0/s_axis_c2h_tdata_0]
  connect_bd_net -net c2h_tkeep_dout  [get_bd_pins c2h_tkeep/dout] \
  [get_bd_pins xdma_0/s_axis_c2h_tkeep_0] \
  [get_bd_pins xdma_0/s_axis_c2h_tkeep_1] \
  [get_bd_pins xdma_0/s_axis_c2h_tkeep_2] \
  [get_bd_pins xdma_0/s_axis_c2h_tkeep_3]
  connect_bd_net -net c2h_tlast_dout  [get_bd_pins c2h_tlast/dout] \
  [get_bd_pins xdma_0/s_axis_c2h_tlast_3] \
  [get_bd_pins xdma_0/s_axis_c2h_tlast_2] \
  [get_bd_pins xdma_0/s_axis_c2h_tlast_1] \
  [get_bd_pins xdma_0/s_axis_c2h_tlast_0]
  connect_bd_net -net c2h_tready_dout  [get_bd_pins c2h_tvalid/dout] \
  [get_bd_pins xdma_0/s_axis_c2h_tvalid_0] \
  [get_bd_pins xdma_0/s_axis_c2h_tvalid_1] \
  [get_bd_pins xdma_0/s_axis_c2h_tvalid_2] \
  [get_bd_pins xdma_0/s_axis_c2h_tvalid_3]
  connect_bd_net -net h2c_tready_dout  [get_bd_pins h2c_tready/dout] \
  [get_bd_pins xdma_0/m_axis_h2c_tready_0] \
  [get_bd_pins xdma_0/m_axis_h2c_tready_1] \
  [get_bd_pins xdma_0/m_axis_h2c_tready_2] \
  [get_bd_pins xdma_0/m_axis_h2c_tready_3]
