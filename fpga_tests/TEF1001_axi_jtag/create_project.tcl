...
#
# create_project.tcl: Tcl script for re-creating project 'TEF1001_axi_jtag'
#
# Generated by Vivado on Thu Dec 19 23:00:40 GMT 2024
...
set _xil_proj_name_ "TEF1001_axi_jtag"
...
set orig_proj_dir "[file normalize "$origin_dir/TEF1001_axi_jtag"]"
...
set_property -name "top" -value "TEF1001_axi_jtag_wrapper" -objects $obj
...
# Proc to create BD TEF1001_axi_jtag
proc cr_bd_TEF1001_axi_jtag { parentCell } {
...
# usr_accesse2_read
  ...
  set design_name TEF1001_axi_jtag
  ...
  connect_bd_intf_net -intf_net CLK_DDR3_200MHz_1 [get_bd_intf_ports CLK_DDR3_200MHz] [get_bd_intf_pins clk_wiz/CLK_IN1_D]
...
# End of cr_bd_TEF1001_axi_jtag()

cr_bd_TEF1001_axi_jtag ""
set_property REGISTERED_WITH_MANAGER "1" [get_files TEF1001_axi_jtag.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files TEF1001_axi_jtag.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list TEF1001_axi_jtag.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/TEF1001_axi_jtag/TEF1001_axi_jtag.gen/sources_1/bd/TEF1001_axi_jtag/hdl/TEF1001_axi_jtag_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list TEF1001_axi_jtag.bd]] -top]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7k160tfbg676-2 -flow {Vivado Synthesis 2024} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7k160tfbg676-2 -flow {Vivado Implementation 2024} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
