...
#
# Generated by Vivado on Mon Aug 25 00:21:12 BST 2025
...
#
#    "/home/mr_halfword/fpga_sio_clean/TEF1001/constraints/_i_pcie.xdc"
#    "/home/mr_halfword/fpga_sio_clean/TEF1001/constraints/_i_bitgen_common.xdc"
#    "/home/mr_halfword/fpga_sio_clean/TEF1001/constraints/_i_common.xdc"
#    "/home/mr_halfword/fpga_sio_clean/fpga_tests/memmapped_blkram/debug.xdc"
#    "/home/mr_halfword/fpga_sio_clean/multiple_boards/copy_bitstream_mask_and_debug_probes.tcl"
#
#*****************************************************************************************
...
proc cr_bd_msys { parentCell } {
  ...
  set_property CONFIG.C_BUF_TYPE {IBUFDSGTE} $util_ds_buf_2
  ...
  connect_bd_net -net axi_pcie_0_axi_aclk_out [get_bd_pins axi_pcie_0/axi_aclk_out] [get_bd_pins axi_bram_ctrl_0/s_axi_aclk] [get_bd_pins axi_bram_ctrl_1/s_axi_aclk] [get_bd_pins axi_bram_ctrl_2/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins rst_mig_7series_0_125M/slowest_sync_clk]
  connect_bd_net -net rst_mig_7series_0_125M_peripheral_aresetn [get_bd_pins rst_mig_7series_0_125M/peripheral_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_1/s_axi_aresetn] [get_bd_pins axi_bram_ctrl_2/s_axi_aresetn] [get_bd_pins axi_pcie_0/axi_aresetn] [get_bd_pins axi_smc/aresetn]
  connect_bd_net -net util_ds_buf_2_IBUF_OUT [get_bd_pins util_ds_buf_2/IBUF_OUT] [get_bd_pins axi_pcie_0/REFCLK]
...
if { [get_property IS_LOCKED [ get_files -norecurse [list msys.bd]] ] == 1  } {
  ...
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list msys.bd]] -top]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7k160tfbg676-2 -flow {Vivado Synthesis 2022} -strategy "Flow_PerfOptimized_high" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7k160tfbg676-2 -flow {Vivado Implementation 2024} -strategy "Performance_NetDelay_low" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
