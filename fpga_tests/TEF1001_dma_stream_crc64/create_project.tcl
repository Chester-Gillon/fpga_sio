...
#
# create_project.tcl: Tcl script for re-creating project 'TEF1001_dma_stream_crc64'
#
# Generated by Vivado on Sun May 31 18:38:53 BST 2026
...
#    "/home/mr_halfword/fpga_sio/TEF1001/constraints/clk_ddr3.xdc"
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/../../TEF1001/constraints/clk_ddr3.xdc"]"\
...
set _xil_proj_name_ "TEF1001_dma_stream_crc64"
...
set orig_proj_dir "[file normalize "$origin_dir/TEF1001_dma_stream_crc64"]"
...
set_property -name "top" -value "TEF1001_dma_stream_crc64_wrapper" -objects $obj
...
# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../../TEF1001/constraints/clk_ddr3.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../TEF1001/constraints/clk_ddr3.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
...
# Proc to create BD TEF1001_dma_stream_crc64
proc cr_bd_TEF1001_dma_stream_crc64 { parentCell } {
# The design that will be created by this Tcl proc contains the following 
# module references:
# usr_accesse2_read, i2c_mux, stream_crc, stream_crc



  # CHANGE DESIGN NAME HERE
  set design_name TEF1001_dma_stream_crc64
  ...
  set_property -dict [list \
    ...
    CONFIG.CLKOUT6_JITTER {112.316} \
    CONFIG.CLKOUT6_PHASE_ERROR {89.971} \
    CONFIG.CLKOUT6_USED {true} \
    CONFIG.CLKOUT7_JITTER {71.915} \
  ...
  connect_bd_intf_net -intf_net CLK_DDR3_1 [get_bd_intf_ports CLK_DDR3_200MHz] [get_bd_intf_pins clk_wiz_0/CLK_IN1_D]
...
# End of cr_bd_TEF1001_dma_stream_crc64()

cr_bd_TEF1001_dma_stream_crc64 ""
set_property REGISTERED_WITH_MANAGER "1" [get_files TEF1001_dma_stream_crc64.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files TEF1001_dma_stream_crc64.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list TEF1001_dma_stream_crc64.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/TEF1001_dma_stream_crc64/TEF1001_dma_stream_crc64.gen/sources_1/bd/TEF1001_dma_stream_crc64/hdl/TEF1001_dma_stream_crc64_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list TEF1001_dma_stream_crc64.bd]] -top]
