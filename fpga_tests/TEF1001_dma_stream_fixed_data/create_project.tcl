...
#
# create_project.tcl: Tcl script for re-creating project 'TEF1001_dma_stream_fixed_data'
#
# Generated by Vivado on Wed Dec 25 19:55:50 GMT 2024
...
set _xil_proj_name_ "TEF1001_dma_stream_fixed_data"
...
set orig_proj_dir "[file normalize "$origin_dir/TEF1001_dma_stream_fixed_data"]"
...
set_property -name "top" -value "TEF1001_dma_stream_fixed_data_wrapper" -objects $obj
...
# Proc to create BD TEF1001_dma_stream_fixed_data
proc cr_bd_TEF1001_dma_stream_fixed_data { parentCell } {
# The design that will be created by this Tcl proc contains the following 
# module references:
# usr_accesse2_read, i2c_mux, axi_stream_sink, axi_stream_sink, axi_stream_source_fixed_data, axi_stream_source_fixed_data



  # CHANGE DESIGN NAME HERE
  set design_name TEF1001_dma_stream_fixed_data
  ...
  connect_bd_intf_net -intf_net axi_iic_0_IIC [get_bd_intf_pins axi_iic_0/IIC] [get_bd_intf_pins i2c_mux_0/IIC]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M02_AXI [get_bd_intf_pins smartconnect_0/M02_AXI] [get_bd_intf_pins axi_iic_0/S_AXI]
  ...
  connect_bd_intf_net -intf_net smartconnect_0_M04_AXI [get_bd_intf_pins smartconnect_0/M04_AXI] [get_bd_intf_pins xadc_wiz_0/s_axi_lite]
  ...
  [get_bd_pins i2c_mux_0/gpio_io_o]
  connect_bd_net -net axi_gpio_0_gpio_io_t  [get_bd_pins axi_gpio_0/gpio_io_t] \
  [get_bd_pins i2c_mux_0/gpio_io_t]
  connect_bd_net -net i2c_mux_0_gpio_io_i  [get_bd_pins i2c_mux_0/gpio_io_i] \
...
# End of cr_bd_TEF1001_dma_stream_fixed_data()

cr_bd_TEF1001_dma_stream_fixed_data ""
set_property REGISTERED_WITH_MANAGER "1" [get_files TEF1001_dma_stream_fixed_data.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files TEF1001_dma_stream_fixed_data.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list TEF1001_dma_stream_fixed_data.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/TEF1001_dma_stream_fixed_data/TEF1001_dma_stream_fixed_data.gen/sources_1/bd/TEF1001_dma_stream_fixed_data/hdl/TEF1001_dma_stream_fixed_data_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list TEF1001_dma_stream_fixed_data.bd]] -top]
