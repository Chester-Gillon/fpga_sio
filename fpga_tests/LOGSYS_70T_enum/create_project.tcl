...
#
# create_project.tcl: Tcl script for re-creating project 'LOGSYS_70T_enum'
#
# Generated by Vivado on Sat Jun 27 17:05:01 BST 2026
...
#    "/home/mr_halfword/fpga_sio/LOGSYS_70T/constraints/pcie.xdc"
#    "/home/mr_halfword/fpga_sio/LOGSYS_70T/constraints/quadspi.xdc"
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/../../LOGSYS_70T/constraints/pcie.xdc"]"\
 "[file normalize "$origin_dir/../../LOGSYS_70T/constraints/quadspi.xdc"]"\
...
set _xil_proj_name_ "LOGSYS_70T_enum"
...
set orig_proj_dir "[file normalize "$origin_dir/LOGSYS_70T_enum"]"
...
set_property -name "top" -value "LOGSYS_70T_enum_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../../LOGSYS_70T/constraints/pcie.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../LOGSYS_70T/constraints/pcie.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj

# Add/Import constrs file and set constrs file properties
set file "[file normalize "$origin_dir/../../LOGSYS_70T/constraints/quadspi.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../LOGSYS_70T/constraints/quadspi.xdc"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets constrs_1] [list "*$file"]]
set_property -name "file_type" -value "XDC" -objects $file_obj
...
# Proc to create BD LOGSYS_70T_enum
proc cr_bd_LOGSYS_70T_enum { parentCell } {
...
# usr_accesse2_read
  ...
  set design_name LOGSYS_70T_enum
...
# End of cr_bd_LOGSYS_70T_enum()

cr_bd_LOGSYS_70T_enum ""
set_property REGISTERED_WITH_MANAGER "1" [get_files LOGSYS_70T_enum.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files LOGSYS_70T_enum.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list LOGSYS_70T_enum.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/LOGSYS_70T_enum/LOGSYS_70T_enum.gen/sources_1/bd/LOGSYS_70T_enum/hdl/LOGSYS_70T_enum_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list LOGSYS_70T_enum.bd]] -top]
...
if {[string equal [get_runs -quiet synth_1] ""]} {
    create_run -name synth_1 -part xc7k70tfbg676-1 -flow {Vivado Synthesis 2025} -strategy "Vivado Synthesis Defaults" -report_strategy {No Reports} -constrset constrs_1
} else {
...
if {[string equal [get_runs -quiet impl_1] ""]} {
    create_run -name impl_1 -part xc7k70tfbg676-1 -flow {Vivado Implementation 2025} -strategy "Vivado Implementation Defaults" -report_strategy {No Reports} -constrset constrs_1 -parent_run synth_1
} else {
