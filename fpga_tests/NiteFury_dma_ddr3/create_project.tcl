...
#
# create_project.tcl: Tcl script for re-creating project 'NiteFury_dma_ddr3'
#
# Generated by Vivado on Sat Feb 24 17:10:48 GMT 2024
...
#    "/home/mr_halfword/fpga_sio/NiteFury/constraints/ddr3_clk.xdc"
...
proc checkRequiredFiles { origin_dir} {
 ...
 "[file normalize "$origin_dir/../../NiteFury/constraints/ddr3_clk.xdc"]"\
...
set _xil_proj_name_ "NiteFury_dma_ddr3"
...
set orig_proj_dir "[file normalize "$origin_dir/NiteFury_dma_ddr3"]"
...
set_property -name "top" -value "NiteFury_dma_ddr3_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../../NiteFury/constraints/ddr3_clk.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../NiteFury/constraints/ddr3_clk.xdc"
set file [file normalize $file]
...
# Proc to create BD NiteFury_dma_ddr3
proc cr_bd_NiteFury_dma_ddr3 { parentCell } {
...
# usr_accesse2_read
  ...
  set design_name NiteFury_dma_ddr3
...
proc write_mig_file_NiteFury_dma_ddr3_mig_7series_0_0 { str_mig_prj_filepath } {
   ...
   puts $mig_prj_file {  <ModuleName>NiteFury_dma_ddr3_mig_7series_0_0</ModuleName>}
...
# End of write_mig_file_NiteFury_dma_ddr3_mig_7series_0_0()
  ...
  write_mig_file_NiteFury_dma_ddr3_mig_7series_0_0 $str_mig_file_path
  ...
  set_property CONFIG.DIN_WIDTH {5} $xlslice_0
  ...
  connect_bd_net -net mig_7series_0_mmcm_locked [get_bd_pins mig_7series_0/mmcm_locked] [get_bd_pins xlconcat_0/In2]
  connect_bd_net -net mig_7series_0_ui_clk [get_bd_pins mig_7series_0/ui_clk] [get_bd_pins axi_smc/aclk1]
  connect_bd_net -net mig_7series_0_ui_clk_sync_rst [get_bd_pins mig_7series_0/ui_clk_sync_rst] [get_bd_pins util_vector_logic_0/Op1] [get_bd_pins xlconcat_0/In4]
  ...
  connect_bd_net -net util_vector_logic_0_Res [get_bd_pins util_vector_logic_0/Res] [get_bd_pins axi_smc/aresetn]
  connect_bd_net -net util_vector_logic_1_Res [get_bd_pins util_vector_logic_1/Res] [get_bd_pins mig_7series_0/aresetn] [get_bd_pins mig_7series_0/sys_rst]
  connect_bd_net -net xadc_wiz_0_temp_out [get_bd_pins xadc_wiz_0/temp_out] [get_bd_pins mig_7series_0/device_temp_i]
  connect_bd_net -net xdma_0_axi_aclk [get_bd_pins xdma_0/axi_aclk] [get_bd_pins xdma_0_axi_periph/S00_ACLK] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins xdma_0_axi_periph/M00_ACLK] [get_bd_pins xdma_0_axi_periph/ACLK] [get_bd_pins xadc_wiz_0/s_axi_aclk] [get_bd_pins xdma_0_axi_periph/M01_ACLK] [get_bd_pins axi_smc/aclk] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins xdma_0_axi_periph/M02_ACLK] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins xdma_0_axi_periph/M03_ACLK]
  connect_bd_net -net xdma_0_axi_aresetn [get_bd_pins xdma_0/axi_aresetn] [get_bd_pins xdma_0_axi_periph/S00_ARESETN] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins xdma_0_axi_periph/M00_ARESETN] [get_bd_pins xdma_0_axi_periph/ARESETN] [get_bd_pins xadc_wiz_0/s_axi_aresetn] [get_bd_pins xdma_0_axi_periph/M01_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins xdma_0_axi_periph/M02_ARESETN] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins xdma_0_axi_periph/M03_ARESETN]
  connect_bd_net -net xlconcat_0_dout [get_bd_pins xlconcat_0/dout] [get_bd_pins axi_gpio_1/gpio_io_i]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins xlconcat_0/In0] [get_bd_pins xlconcat_0/In1]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconstant_1/dout] [get_bd_ports pcie_clkreq_l]
  connect_bd_net -net xlslice_0_Dout [get_bd_pins xlslice_0/Dout] [get_bd_pins util_vector_logic_1/Op1]
...
# End of cr_bd_NiteFury_dma_ddr3()

cr_bd_NiteFury_dma_ddr3 ""
set_property REGISTERED_WITH_MANAGER "1" [get_files NiteFury_dma_ddr3.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files NiteFury_dma_ddr3.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list NiteFury_dma_ddr3.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/NiteFury_dma_ddr3/NiteFury_dma_ddr3.gen/sources_1/bd/NiteFury_dma_ddr3/hdl/NiteFury_dma_ddr3_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list NiteFury_dma_ddr3.bd]] -top]
