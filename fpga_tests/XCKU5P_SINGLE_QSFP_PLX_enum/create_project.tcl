...
#
# create_project.tcl: Tcl script for re-creating project 'XCKU5P_SINGLE_QSFP_PLX_enum'
#
# Generated by Vivado on Mon Aug 31 19:04:58 BST 2026
...
set _xil_proj_name_ "XCKU5P_SINGLE_QSFP_PLX_enum"
...
set orig_proj_dir "[file normalize "$origin_dir/XCKU5P_SINGLE_QSFP_PLX_enum"]"
...
set_property -name "top" -value "XCKU5P_SINGLE_QSFP_PLX_enum_wrapper" -objects $obj
...
# Proc to create BD XCKU5P_SINGLE_QSFP_PLX_enum
proc cr_bd_XCKU5P_SINGLE_QSFP_PLX_enum { parentCell } {
...
# usr_accesse2_read
  ...
  set design_name XCKU5P_SINGLE_QSFP_PLX_enum
  ...
  set_property -dict [list \
    ...
    CONFIG.pf0_device_id {9056} \
    CONFIG.pf0_interrupt_pin {NONE} \
    CONFIG.pf0_msi_enabled {false} \
    CONFIG.pf0_revision_id {aa} \
    CONFIG.pf0_subsystem_id {3198} \
    CONFIG.pf0_subsystem_vendor_id {10b5} \
    CONFIG.pl_link_cap_max_link_speed {8.0_GT/s} \
    CONFIG.pl_link_cap_max_link_width {X8} \
    CONFIG.select_quad {GTY_Quad_225} \
    CONFIG.vendor_id {10b5} \
  ...
  connect_bd_intf_net -intf_net axi_smc_M01_AXI [get_bd_intf_pins axi_smc/M01_AXI] [get_bd_intf_pins system_management_wiz_0/S_AXI_LITE]
...
# End of cr_bd_XCKU5P_SINGLE_QSFP_PLX_enum()

cr_bd_XCKU5P_SINGLE_QSFP_PLX_enum ""
set_property REGISTERED_WITH_MANAGER "1" [get_files XCKU5P_SINGLE_QSFP_PLX_enum.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files XCKU5P_SINGLE_QSFP_PLX_enum.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list XCKU5P_SINGLE_QSFP_PLX_enum.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/XCKU5P_SINGLE_QSFP_PLX_enum/XCKU5P_SINGLE_QSFP_PLX_enum.gen/sources_1/bd/XCKU5P_SINGLE_QSFP_PLX_enum/hdl/XCKU5P_SINGLE_QSFP_PLX_enum_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list XCKU5P_SINGLE_QSFP_PLX_enum.bd]] -top]
