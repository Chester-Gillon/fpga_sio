...
#
# create_project.tcl: Tcl script for re-creating project 'U200_qdma_ram'
#
# Generated by Vivado on Thu Jan 01 08:53:44 GMT 2026
...
set _xil_proj_name_ "U200_qdma_ram"
...
set orig_proj_dir "[file normalize "$origin_dir/U200_qdma_ram"]"
...
set_property -name "top" -value "U200_qdma_ram_wrapper" -objects $obj
...
# Proc to create BD U200_qdma_ram
proc cr_bd_U200_qdma_ram { parentCell } {
...
# usr_accesse2_read
  ...
  assign_bd_address -offset 0x00000000 -range 0x00800000 -target_address_space [get_bd_addr_spaces qdma_0/M_AXI] [get_bd_addr_segs axi_bram_ctrl_0/S_AXI/Mem0] -force
...
# End of cr_bd_U200_qdma_ram()

cr_bd_U200_qdma_ram ""
set_property REGISTERED_WITH_MANAGER "1" [get_files U200_qdma_ram.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files U200_qdma_ram.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list U200_qdma_ram.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/U200_qdma_ram/U200_qdma_ram.gen/sources_1/bd/U200_qdma_ram/hdl/U200_qdma_ram_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list U200_qdma_ram.bd]] -top]
