...
#
# Generated by Vivado on Sat Jul 15 13:38:54 BST 2023
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/i2c_mux.vhd"]"\
...
set file "$origin_dir/i2c_mux.vhd"
...
# i2c_mux
  ...
  set_property CONFIG.NUM_MI {4} $axi_pcie_0_axi_periph
  ...
  connect_bd_intf_net -intf_net axi_pcie_0_axi_periph_M01_AXI [get_bd_intf_pins axi_gpio_0/S_AXI] [get_bd_intf_pins axi_pcie_0_axi_periph/M01_AXI]
  connect_bd_intf_net -intf_net axi_pcie_0_axi_periph_M02_AXI [get_bd_intf_pins axi_pcie_0_axi_periph/M02_AXI] [get_bd_intf_pins axi_quad_spi_0/AXI_LITE]
  connect_bd_intf_net -intf_net axi_pcie_0_axi_periph_M03_AXI [get_bd_intf_pins axi_pcie_0_axi_periph/M03_AXI] [get_bd_intf_pins xadc_wiz_0/s_axi_lite]
  ...
  connect_bd_net -net axi_pcie_0_axi_aclk_out [get_bd_pins axi_pcie_0/axi_aclk_out] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins axi_pcie_0_axi_periph/ACLK] [get_bd_pins axi_pcie_0_axi_periph/M00_ACLK] [get_bd_pins axi_pcie_0_axi_periph/M01_ACLK] [get_bd_pins axi_pcie_0_axi_periph/S00_ACLK] [get_bd_pins rst_axi_pcie_0_125M/slowest_sync_clk] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins axi_pcie_0_axi_periph/M02_ACLK] [get_bd_pins axi_quad_spi_0/ext_spi_clk] [get_bd_pins xadc_wiz_0/s_axi_aclk] [get_bd_pins axi_pcie_0_axi_periph/M03_ACLK]
  connect_bd_net -net i2c_mux_0_gpio_io_i [get_bd_pins i2c_mux_0/gpio_io_i] [get_bd_pins axi_gpio_0/gpio_io_i]
  connect_bd_net -net rst_axi_pcie_0_125M_peripheral_aresetn [get_bd_pins rst_axi_pcie_0_125M/peripheral_aresetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins axi_pcie_0/axi_aresetn] [get_bd_pins axi_pcie_0_axi_periph/ARESETN] [get_bd_pins axi_pcie_0_axi_periph/M00_ARESETN] [get_bd_pins axi_pcie_0_axi_periph/M01_ARESETN] [get_bd_pins axi_pcie_0_axi_periph/S00_ARESETN] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins axi_pcie_0_axi_periph/M02_ARESETN] [get_bd_pins xadc_wiz_0/s_axi_aresetn] [get_bd_pins axi_pcie_0_axi_periph/M03_ARESETN]
  connect_bd_net -net util_ds_buf_0_IBUF_OUT [get_bd_pins util_ds_buf_0/IBUF_OUT] [get_bd_pins axi_pcie_0/REFCLK]

  # Create address segments
  assign_bd_address -offset 0x00001000 -range 0x00001000 -target_address_space [get_bd_addr_spaces axi_pcie_0/M_AXI] [get_bd_addr_segs axi_gpio_0/S_AXI/Reg] -force
  ...
  assign_bd_address -offset 0x00002000 -range 0x00001000 -target_address_space [get_bd_addr_spaces axi_pcie_0/M_AXI] [get_bd_addr_segs axi_quad_spi_0/AXI_LITE/Reg] -force
  assign_bd_address -offset 0x00003000 -range 0x00001000 -target_address_space [get_bd_addr_spaces axi_pcie_0/M_AXI] [get_bd_addr_segs xadc_wiz_0/s_axi_lite/Reg] -force
