...
#
# create_project.tcl: Tcl script for re-creating project 'TEF1001_dma_stream_loopback'
#
# Generated by Vivado on Sat Feb 24 16:20:15 GMT 2024
...
set _xil_proj_name_ "TEF1001_dma_stream_loopback"
...
set orig_proj_dir "[file normalize "$origin_dir/TEF1001_dma_stream_loopback"]"
...
set_property -name "top" -value "TEF1001_dma_stream_loopback_wrapper" -objects $obj
...
# Proc to create BD TEF1001_dma_stream_loopback
proc cr_bd_TEF1001_dma_stream_loopback { parentCell } {
# The design that will be created by this Tcl proc contains the following 
# module references:
# usr_accesse2_read, i2c_mux



  # CHANGE DESIGN NAME HERE
  set design_name TEF1001_dma_stream_loopback
  ...
  connect_bd_intf_net -intf_net xdma_0_axi_periph_M01_AXI [get_bd_intf_pins xdma_0_axi_periph/M01_AXI] [get_bd_intf_pins axi_gpio_1/S_AXI]
  ...
  connect_bd_intf_net -intf_net xdma_0_axi_periph_M04_AXI [get_bd_intf_pins xdma_0_axi_periph/M04_AXI] [get_bd_intf_pins axi_iic_0/S_AXI]
  ...
  connect_bd_net -net xdma_0_axi_aclk [get_bd_pins xdma_0/axi_aclk] [get_bd_pins xdma_0_axi_periph/S00_ACLK] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins xdma_0_axi_periph/M00_ACLK] [get_bd_pins xdma_0_axi_periph/ACLK] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins xdma_0_axi_periph/M01_ACLK] [get_bd_pins axi_quad_spi_0/s_axi_aclk] [get_bd_pins xdma_0_axi_periph/M02_ACLK] [get_bd_pins xadc_wiz_0/s_axi_aclk] [get_bd_pins xdma_0_axi_periph/M03_ACLK] [get_bd_pins axi_iic_0/s_axi_aclk] [get_bd_pins xdma_0_axi_periph/M04_ACLK] [get_bd_pins axi_quad_spi_0/ext_spi_clk]
  connect_bd_net -net xdma_0_axi_aresetn [get_bd_pins xdma_0/axi_aresetn] [get_bd_pins xdma_0_axi_periph/S00_ARESETN] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins xdma_0_axi_periph/M00_ARESETN] [get_bd_pins xdma_0_axi_periph/ARESETN] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins xdma_0_axi_periph/M01_ARESETN] [get_bd_pins axi_quad_spi_0/s_axi_aresetn] [get_bd_pins xdma_0_axi_periph/M02_ARESETN] [get_bd_pins xadc_wiz_0/s_axi_aresetn] [get_bd_pins xdma_0_axi_periph/M03_ARESETN] [get_bd_pins axi_iic_0/s_axi_aresetn] [get_bd_pins xdma_0_axi_periph/M04_ARESETN]
...
# End of cr_bd_TEF1001_dma_stream_loopback()

cr_bd_TEF1001_dma_stream_loopback ""
set_property REGISTERED_WITH_MANAGER "1" [get_files TEF1001_dma_stream_loopback.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files TEF1001_dma_stream_loopback.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list TEF1001_dma_stream_loopback.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/TEF1001_dma_stream_loopback/TEF1001_dma_stream_loopback.gen/sources_1/bd/TEF1001_dma_stream_loopback/hdl/TEF1001_dma_stream_loopback_wrapper.v" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list TEF1001_dma_stream_loopback.bd]] -top]
