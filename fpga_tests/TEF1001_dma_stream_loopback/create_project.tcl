...
#
# Generated by Vivado on Sun Jan 14 11:57:46 GMT 2024
...
if { [get_property IS_LOCKED [ get_files -norecurse TEF1001_dma_stream_loopback.bd] ] == 1  } {
  ...
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse TEF1001_dma_stream_loopback.bd] -top]
