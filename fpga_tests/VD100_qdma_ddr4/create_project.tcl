...
#
# create_project.tcl: Tcl script for re-creating project 'VD100_qdma_ddr4'
#
# Generated by Vivado on Tue Dec 30 11:09:21 GMT 2025
...
#
#    "/home/mr_halfword/fpga_sio/VD100/constraints/ddr4.xdc"
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
 "[file normalize "$origin_dir/../../VD100/constraints/ddr4.xdc"]"\
...
set _xil_proj_name_ "VD100_qdma_ddr4"
...
set orig_proj_dir "[file normalize "$origin_dir/VD100_qdma_ddr4"]"
...
set_property -name "top" -value "VD100_qdma_ddr4_wrapper" -objects $obj
...
set file "[file normalize "$origin_dir/../../VD100/constraints/ddr4.xdc"]"
set file_added [add_files -norecurse -fileset $obj [list $file]]
set file "$origin_dir/../../VD100/constraints/ddr4.xdc"
...
# Proc to create BD VD100_qdma_ddr4
proc cr_bd_VD100_qdma_ddr4 { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name VD100_qdma_ddr4
...
proc create_hier_cell_qdma_0_support { parentCell nameHier } {
  ...
  set_property -dict [list \
    ...
    CONFIG.VFG0_MSIX_CAP_TABLE_SIZE {000} \
    CONFIG.VFG1_MSIX_CAP_PBA_BIR {BAR_1:0} \
    CONFIG.VFG1_MSIX_CAP_PBA_OFFSET {4800} \
    CONFIG.VFG1_MSIX_CAP_TABLE_BIR {BAR_1:0} \
    CONFIG.VFG1_MSIX_CAP_TABLE_OFFSET {4000} \
    CONFIG.VFG1_MSIX_CAP_TABLE_SIZE {000} \
    CONFIG.VFG2_MSIX_CAP_PBA_BIR {BAR_1:0} \
    CONFIG.VFG2_MSIX_CAP_PBA_OFFSET {4800} \
    CONFIG.VFG2_MSIX_CAP_TABLE_BIR {BAR_1:0} \
    CONFIG.VFG2_MSIX_CAP_TABLE_OFFSET {4000} \
    CONFIG.VFG2_MSIX_CAP_TABLE_SIZE {000} \
    CONFIG.VFG3_MSIX_CAP_PBA_BIR {BAR_1:0} \
    CONFIG.VFG3_MSIX_CAP_PBA_OFFSET {4800} \
    CONFIG.VFG3_MSIX_CAP_TABLE_BIR {BAR_1:0} \
    CONFIG.VFG3_MSIX_CAP_TABLE_OFFSET {4000} \
    CONFIG.VFG3_MSIX_CAP_TABLE_SIZE {000} \
    ...
    CONFIG.pf1_sub_class_interface_menu {RAM} \
...
32 RX_REFCLK_FREQUENCY 100} \
    CONFIG.INTF0_PARENTID {VD100_qdma_ddr4_pcie_phy_0} \
...
refclk_PROT0_R0_100_MHz_unique1} \
  ...
  set PL_CLK0 [ create_bd_intf_port -mode Slave -vlnv xilinx.com:interface:diff_clock_rtl:1.0 PL_CLK0 ]
  set_property -dict [ list \
  ...
  set_property -dict [ list \
   ...
   CONFIG.CONNECTIONS {MC_0 {read_bw {12250} write_bw {12250} read_avg_burst {4} write_avg_burst {4} }} \
   CONFIG.NOC_PARAMS {} \
   CONFIG.CATEGORY {pl} \
  ...
  connect_bd_intf_net -intf_net diff_clock_rtl_0_1 [get_bd_intf_ports PL_CLK0] [get_bd_intf_pins axi_noc_0/sys_clk0]
  connect_bd_intf_net -intf_net pcie_refclk_1 [get_bd_intf_ports pcie_refclk] [get_bd_intf_pins qdma_0_support/pcie_refclk]
  connect_bd_intf_net -intf_net qdma_0_M_AXI [get_bd_intf_pins qdma_0/M_AXI] [get_bd_intf_pins axi_noc_0/S00_AXI]
  ...
  # Create port connections
  create_bd_net BUFG_GT_CE_1
  connect_bd_net -net [get_bd_nets BUFG_GT_CE_1]  [get_bd_pins qdma_0_support/gtpowergood] \
  [get_bd_pins qdma_0_support/BUFG_GT_CE]
  connect_bd_net -net gtwiz_freerun_clk_1  [get_bd_pins versal_cips_0/pl0_ref_clk] \
  [get_bd_pins qdma_0_support/gtwiz_freerun_clk]
  ...
  assign_bd_address -offset 0x000800000000 -range 0x000100000000 -target_address_space [get_bd_addr_spaces qdma_0/M_AXI] [get_bd_addr_segs axi_noc_0/S00_AXI/C0_DDR_LOW1] -force
...
# End of cr_bd_VD100_qdma_ddr4()

cr_bd_VD100_qdma_ddr4 ""
set_property REGISTERED_WITH_MANAGER "1" [get_files VD100_qdma_ddr4.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files VD100_qdma_ddr4.bd ] 

#call make_wrapper to create wrapper files
if { [get_property IS_LOCKED [ get_files -norecurse [list VD100_qdma_ddr4.bd]] ] == 1  } {
  import_files -fileset sources_1 [file normalize "${origin_dir}/VD100_qdma_ddr4/VD100_qdma_ddr4.gen/sources_1/bd/VD100_qdma_ddr4/hdl/VD100_qdma_ddr4_wrapper.vhd" ]
} else {
  set wrapper_path [make_wrapper -fileset sources_1 -files [ get_files -norecurse [list VD100_qdma_ddr4.bd]] -top]
