...
#
# Generated by Vivado on Sun Oct 02 14:38:26 BST 2022
...
proc cr_bd_msys { parentCell } {
  ...
  set_property -dict [ list \
   CONFIG.Acceptable_L1_Latency {Maximum_of_1_us} \
   ...
   CONFIG.Class_Code_Base {06} \
   CONFIG.Class_Code_Sub {04} \
   CONFIG.Device_ID {7114} \
   CONFIG.Device_Port_Type {Root_Port_of_PCI_Express_Root_Complex} \
   CONFIG.IO_Base_Limit_Registers {16-bit_I/O_Addressing} \
   CONFIG.Interface_Width {64_bit} \
   CONFIG.Link_Speed {2.5_GT/s} \
   CONFIG.MSIx_PBA_BIR {BAR_1} \
   CONFIG.MSIx_Table_BIR {BAR_1} \
   CONFIG.Max_Payload_Size {512_bytes} \
   CONFIG.Maximum_Link_Width {X4} \
   CONFIG.PCIe_Blk_Locn {X0Y0} \
   CONFIG.Pcie_fast_config {None} \
   CONFIG.Prefetchable_Memory_Base_Limit_Registers {64-bit_Addressing} \
   CONFIG.RBAR_Num {0} \
  ...
  connect_bd_net -net pcie_7x_0_user_clk_out [get_bd_pins pcie_7x_0/user_clk_out] [get_bd_pins rst_mig_7series_0_125M/slowest_sync_clk]
  connect_bd_net -net rst_mig_7series_0_125M_peripheral_aresetn [get_bd_pins pcie_7x_0/sys_rst_n] [get_bd_pins rst_mig_7series_0_125M/peripheral_aresetn]
  connect_bd_net -net util_ds_buf_2_IBUF_OUT [get_bd_pins pcie_7x_0/sys_clk] [get_bd_pins util_ds_buf_2/IBUF_OUT]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins pcie_7x_0/s_axis_tx_tvalid] [get_bd_pins xlconstant_0/dout]
