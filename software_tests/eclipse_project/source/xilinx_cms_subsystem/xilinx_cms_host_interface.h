...
#define CMS_OP_BLOCK_READ_MODULE_I2C_OPCODE     0x0B
#define CMS_OP_READ_MODULE_LOW_SPEED_IO_OPCODE  0x0D
#define CMS_OP_WRITE_MODULE_LOW_SPEED_IO_OPCODE 0x0E
#define CMS_OP_BYTE_READ_MODULE_I2C_OPCODE      0x0F

#define CMS_MAILBOX_PAYLOAD_START_OFFSET   0x4

/* Extended I2C Addressing request word for CMS_OP_BLOCK_READ_MODULE_I2C_OPCODE and CMS_CMS_OP_BYTE_READ_MODULE_I2C_OPCODE */
#define CMS_EXT_I2C_ADDR_CMIS_BANK_MASK             0x007C0000
#define CMS_EXT_I2C_ADDR_CMIS_BANK_FIELD_VALID_MASK 0x00020000
#define CMS_EXT_I2C_ADDR_USE_SFP_PLUS_DIAG_MASK     0x00010000
#define CMS_EXT_I2C_ADDR_UPPER_PAGE_SELECT_MASK     0x00000001
