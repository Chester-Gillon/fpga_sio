...
typedef enum
{
    ...
    QUAD_SPI_FLASH_MICRON_N25QU256,
    QUAD_SPI_FLASH_MICRON_MT25QU128,
    QUAD_SPI_FLASH_MICRON_MT25QU256,
...
typedef struct
{
    ...
    union
    {
        ...
        /* For QUAD_SPI_FLASH_MICRON_*25Q* */
        micron_25q_parameters_t micron_25q_params;
