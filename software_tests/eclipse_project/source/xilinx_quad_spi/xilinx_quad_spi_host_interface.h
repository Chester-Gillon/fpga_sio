...
#define XSPI_OPCODE_SUBSECTOR_ERASE_3_BYTE_ADDRESS                 0x20
...
#define XSPI_OPCODE_DUAL_IO_READ_3_BYTE_ADDRESS                    0xBB
#define XSPI_OPCODE_DUAL_IO_READ_4_BYTE_ADDRESS                    0xBC
#define XSPI_OPCODE_SECTOR_ERASE_3_BYTE_ADDRESS                    0xD8
#define XSPI_OPCODE_SECTOR_ERASE_4_BYTE_ADDRESS                    0xDC
#define XSPI_OPCODE_QUAD_IO_READ_3_BYTE_ADDRESS                    0xEB
